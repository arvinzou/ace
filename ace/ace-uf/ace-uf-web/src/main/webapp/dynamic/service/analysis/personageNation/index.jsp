...
<script
        src="${pageContext.request.contextPath}/content/service/analysis/personageNation/config.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/analysis/personageNation/controller.js?version=${cfg.version}"></script>
<script

...
<body>
				...
				<div class="widget-main padding-6">
					<form action="#" id="fm-search">
			         ...
			         扶贫进度：<input class="easyui-combobox" style="width: 200px" name="category"
						...
						<button class="btn btn-info" id="btn-search"
							authority="${pageContext.request.contextPath}/fuPin/findFuPinList.do">
							查询
					...
					<div id="toolbar" class="toolbar">
						<button class="btn btn-info" id="btn-view-add"
							authority="${pageContext.request.contextPath}/fuPin/insertFuPin.do">
							添加文件
							 <i class="ace-icon fa fa-plus-square  align-middle bigger-125 icon-on-right"></i>
						</button>
						<button class="btn btn-info" id="btn-view-edit"
							authority="${pageContext.request.contextPath}/fuPin/updateFuPin.do">
							修改
						...
						<button class="btn btn-warning" id="btn-view-del"
							authority="${pageContext.request.contextPath}/fuPin/deleteFuPinByFuPinId.do">
							删除
	...
	<script src="${pageContext.request.contextPath}/content/service/fuPin/config.js?version=${cfg.version}"></script>
	<script src="${pageContext.request.contextPath}/content/service/fuPin/model.js?version=${cfg.version}"></script>
	<script src="${pageContext.request.contextPath}/content/service/fuPin/controller.js?version=${cfg.version}"></script>
	<script src="${pageContext.request.contextPath}/content/service/fuPin/view.js?version=${cfg.version}"></script>
	<script src="${pageContext.request.contextPath}/content/service/fuPin/upload.js?version=${cfg.version}"></script>

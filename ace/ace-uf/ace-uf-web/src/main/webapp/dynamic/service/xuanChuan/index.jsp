            ...
            <div class="widget-main padding-6">
                <form action="#" id="fm-search">
                    ...
                    <button class="btn btn-info" id="btn-search"
                            authority="${pageContext.request.contextPath}/xuanChuan/findXuanChuanList.do">
                        <i
...
<script src="${pageContext.request.contextPath}/content/service/xuanChuan/config.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/xuanChuan/model.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/xuanChuan/controller.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/xuanChuan/view.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/xuanChuan/upload.js?version=${cfg.version}"></script>

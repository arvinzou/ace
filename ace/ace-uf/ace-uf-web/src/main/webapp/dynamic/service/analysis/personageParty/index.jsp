...
<script
        src="${pageContext.request.contextPath}/content/service/analysis/personageParty/config.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/analysis/personageParty/controller.js?version=${cfg.version}"></script>
<script

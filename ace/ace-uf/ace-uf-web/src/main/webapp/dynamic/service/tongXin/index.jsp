...
<div id="dialog-message-view" class="hide">
    ...
    <div class="row" style="padding:10px">
        ...
        <div class="labelItem">
            <span class="labelItemHeader">工程名称</span><br>
            <span id="name"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">工程地点</span><br>
            <span id="address"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">纬度</span><br>
            <span id="latitude"></span>
        </div>

        <div class="labelItem">
            <span class="labelItemHeader">经度</span><br>
            <span id="longitude"></span>
        </div>

        <div class="labelItem">
            <span class="labelItemHeader">联系人</span><br>
            <span id="linkman"></span>
        </div>

        <div class="labelItem">
            <span class="labelItemHeader">联系电话</span><br>
            <span id="tel"></span>
        </div>
    ...
    <div class="row" style="padding:10px">
        <div class="labelItem">
            <span class="labelItemHeader">创建人姓名</span><br>
            <span id="createUserName"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">入库日期</span><br>
            <span id="createDate"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">最后更新人姓名</span><br>
            <span id="lastModifyUserName"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">最后更新时间</span><br>

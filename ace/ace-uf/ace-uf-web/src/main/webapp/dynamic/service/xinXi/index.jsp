            ...
            <div class="widget-main padding-6">
                ...
                <div id="toolbar" class="toolbar">
                    ...
                    <button class="btn btn-info" id="btn-view-add"
                            authority="${pageContext.request.contextPath}/xinXi/insertXinXi.do">
                        <i
                                class="ace-icon fa fa-plus-square  align-middle bigger-125 icon-on-right"></i>
                    </button>
                    <button class="btn btn-info" id="btn-view-edit"
                            authority="${pageContext.request.contextPath}/xinXi/updateXinXi.do">
                        <i
                                class="ace-icon fa fa-edit  align-middle bigger-125 icon-on-right"></i>
                    </button>
                    <button class="btn btn-warning" id="btn-view-del"
                            authority="${pageContext.request.contextPath}/xinXi/deleteXinXiByXinXiId.do">
                        <i
...
<script src="${pageContext.request.contextPath}/content/service/xinXi/config.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/xinXi/model.js?version=${cfg.version}"></script>

                    ...
                    panelHeight:'auto'">
                     ...
                     名称： <input name="name" type="text"
						...
						<button class="btn btn-info" id="btn-search"
							authority="${pageContext.request.contextPath}/organizationSub/findOrganizationSubList.do">
							 <i
...
<span id="lastModifyDate">
	...
	<script
		src="${pageContext.request.contextPath}/content/service/organizationSub/controller.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/organizationSub/view.js?version=${cfg.version}"></script>

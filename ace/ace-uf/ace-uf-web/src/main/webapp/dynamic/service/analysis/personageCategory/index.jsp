...
<script
        src="${pageContext.request.contextPath}/content/service/analysis/personageCategory/config.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/analysis/personageCategory/controller.js?version=${cfg.version}"></script>
<script

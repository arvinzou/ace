...
if (themeSelector) {
    ...
    function selectChange(value){
       ...
       // myChartGauge.showLoading();
        myChartBarJb.showLoading();
        myChartBarYp.showLoading();
    ...
    function refreshTheme(){
       ...
       // myChartGauge.hideLoading();
        myChartBarJb.hideLoading();
        myChartBarYp.hideLoading();
        myChartGaugeSy.hideLoading();
        myChartPie.hideLoading();
        
        myChart.setTheme(curTheme);
      //  myChartGauge.setTheme(curTheme);
        myChartBarJb.setTheme(curTheme);
        myChartBarYp.setTheme(curTheme);

var cfg = {};
cfg.grid_load_data_url = contextPath + '/memberInfo/findMemberInfoList.do?createUserId=2';
cfg.grid_add_data_url = contextPath + '/memberInfo/insertMemberInfo.do';
cfg.grid_edit_data_url = contextPath + '/memberInfo/updateMemberBaseByPrimaryKey.do';

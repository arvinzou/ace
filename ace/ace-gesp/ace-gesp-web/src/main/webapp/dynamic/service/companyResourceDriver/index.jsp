...
<body>
	...
	<script
		src="${pageContext.request.contextPath}/content/service/companyResourceDriver/config.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/companyResourceDriver/model.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/companyResourceDriver/controller.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/companyResourceDriver/view.js?version=${cfg.version}"></script>
	<script

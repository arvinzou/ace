...
<body>
	...
	<script
		src="${pageContext.request.contextPath}/content/service/managerPerforTest/config.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/managerPerforTest/model.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/managerPerforTest/controller.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/managerPerforTest/view.js?version=${cfg.version}"></script>

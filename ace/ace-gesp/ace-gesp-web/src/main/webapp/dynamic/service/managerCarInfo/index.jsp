...
<body>
				...
				<div class="widget-main padding-6">
					<form action="#" id="fm-search">
						...
						车辆类型： <input class="easyui-combobox" style="width: 150px" name="carBigType"
							data-options="url:'${portalPath}/dict/findListByCategoryId.do?categoryId=100&selected=false',
			                    ...
			                    editable:false,
			                    panelHeight:200">	
			           	 审验有效期：<input class="easyui-combobox" style="width: 150px" name="checkValidityDate"
					...
					<div id="toolbar" class="toolbar">
						<%-- <button class="btn btn-info" id="btn-view-update"
							authority="${pageContext.request.contextPath}/managerCar/updateCarTypeInfoById.do">
	...
	<script
		src="${pageContext.request.contextPath}/content/service/managerCarInfo/config.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/managerCarInfo/model.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/managerCarInfo/controller.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/managerCarInfo/view.js?version=${cfg.version}"></script>

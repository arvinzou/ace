...
<body>
			...
			<div class="widget-body">
				<div class="widget-main padding-6">
					<form action="#" id="fm-search">
						<input name="repairType" type="hidden" value="" />
						...
						终检有效期： <input class="easyui-combobox" style="width: 150px" name="checkDate"
	...
	<script
		src="${pageContext.request.contextPath}/content/service/companyRePerforTest/config.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/companyRePerforTest/model.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/companyRePerforTest/controller.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/companyRePerforTest/view.js?version=${cfg.version}"></script>

...
<%
	...
	param.put("gradeId", request.getParameter("gradeId"));
	param.put("classesId", request.getParameter("classesId"));
	
	List<Map<String,Object>> userList=evTaskMapper.selectVoteUserListBySetting(param);
...
<form id="fm-evTask">
	<div class="page-content">
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<div id="vo-content" style="text-align:center">

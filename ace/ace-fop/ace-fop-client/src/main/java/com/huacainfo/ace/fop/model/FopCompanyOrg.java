...
public class FopCompanyOrg implements Serializable {
    private static final long serialVersionUID = 314007139990724959L;
    private String id;
    ...
    public void setDutyPersonPhone(String dutyPersonPhone) {
        this.dutyPersonPhone = dutyPersonPhone == null ? null : dutyPersonPhone.trim();
    }

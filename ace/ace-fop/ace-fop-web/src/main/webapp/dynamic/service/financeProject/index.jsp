        ...
        <div class="row custom-toolbar">
            <form action="#" id="fm-search" >
                <div class="col-md-2 toolbar">
                    <button type="button" class="btn  green" id="btn-view-add"  authority="${pageContext.request.contextPath}/fopFinanceProject/insertFopFinanceProject"></button>
                </div>
...
<script
        src="${pageContext.request.contextPath}/content/service/financeProject/upload.js?version=${cfg.version}"></script>

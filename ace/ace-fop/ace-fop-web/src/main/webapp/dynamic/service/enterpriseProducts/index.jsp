            ...
            <div class="widget-main padding-6">
                <form action="#" id="fm-search">
                    ...
                    <button class="btn btn-info" id="btn-search"
                            authority="${pageContext.request.contextPath}/enterpriseProducts/findEnterpriseProductsList">
                ...
                <div id="toolbar" class="toolbar">
                    ...
                    <button class="btn btn-info" id="btn-view-add"
                            authority="${pageContext.request.contextPath}/enterpriseProducts/insertEnterpriseProducts">
                        <i class="ace-icon fa fa-plus-square  align-middle bigger-125 icon-on-right"></i>
                    </button>
                    <button class="btn btn-info" id="btn-view-edit"
                            authority="${pageContext.request.contextPath}/enterpriseProducts/updateEnterpriseProducts">
                        <i class="ace-icon fa fa-edit  align-middle bigger-125 icon-on-right"></i>
                    </button>
                    <button class="btn btn-warning" id="btn-view-del"
                            authority="${pageContext.request.contextPath}/enterpriseProducts/deleteEnterpriseProductsByEnterpriseProductsId">

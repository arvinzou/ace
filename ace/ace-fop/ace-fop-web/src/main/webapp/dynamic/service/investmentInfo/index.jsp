...
<script
        src="${pageContext.request.contextPath}/content/service/investmentInfo/config.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/investmentInfo/model.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/investmentInfo/controller.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/investmentInfo/view.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/investmentInfo/upload.js?version=${cfg.version}"></script>

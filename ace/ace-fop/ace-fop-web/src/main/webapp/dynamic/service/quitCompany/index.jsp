        ...
        <div class="widget-body">
            <div class="widget-main padding-6">
                ...
                <div id="toolbar" class="toolbar">
                    ...
                    <button class="btn btn-warning" id="btn-view-reJoin"
                            authority="${pageContext.request.contextPath}/fopCompany/reJoin">
                    </button>
                </div>
            </div>
        </div>
...
<script src="${pageContext.request.contextPath}/content/service/quitCompany/config.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/quitCompany/model.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/quitCompany/controller.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/quitCompany/view.js?version=${cfg.version}"></script>

<script src="${pageContext.request.contextPath}/content/service/quitCompany/upload.js?version=${cfg.version}"></script>

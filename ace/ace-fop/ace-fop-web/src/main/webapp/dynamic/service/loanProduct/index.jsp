    ...
    <div class="portlet-body">
        ...
        <div class="row custom-toolbar">
            ...
            <div class="col-md-2 toolbar">
                ...
                <button type="button" class="btn  green" id="btn-view-add" authority="${pageContext.request.contextPath}/fopLoanProduct/insertFopLoanProduct"></button>
...
<div class="modal fade" role="dialog" id="modal-audit">
    <div class="modal-dialog" role="document" style="width: 50%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="/fopLoanProduct/audit" id="fm-audit" role="form">
                    <div class="form-body">

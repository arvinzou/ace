...
<div id="dialog-message-view" class="hide">
    ...
    <div class="row" style="padding:10px">
        ...
        <div class="labelItem">
            ...
            <br>
            <span id="workingCapital"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">自有生产（经营）场地（㎡ ）</span>
            <br>
            <span id="ownSpace"></span>
        </div>
        <div class="labelItem">
...
<script src="${pageContext.request.contextPath}/content/service/individualMember/config.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/individualMember/model.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/individualMember/controller.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/individualMember/view.js?version=${cfg.version}"></script>

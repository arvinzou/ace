...
<script
        src="${pageContext.request.contextPath}/content/service/individualMember/config.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/individualMember/model.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/individualMember/controller.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/individualMember/view.js?version=${cfg.version}"></script>
<script

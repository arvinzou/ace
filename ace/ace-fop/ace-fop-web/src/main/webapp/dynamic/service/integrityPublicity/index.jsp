            ...
            <div class="widget-main padding-6">
                ...
                <div id="toolbar" class="toolbar">
                    ...
                    <button class="btn btn-info" id="btn-view-add"
                            authority="${pageContext.request.contextPath}/integrityPublicity/insertIntegrityPublicity">
                        <i class="ace-icon fa fa-plus-square  align-middle bigger-125 icon-on-right"></i>
                    </button>
                    <button class="btn btn-info" id="btn-view-edit"
                            authority="${pageContext.request.contextPath}/integrityPublicity/updateIntegrityPublicity">
                        <i class="ace-icon fa fa-edit  align-middle bigger-125 icon-on-right"></i>
                    </button>
                    <button class="btn btn-warning" id="btn-view-del"
                            authority="${pageContext.request.contextPath}/integrityPublicity/deleteIntegrityPublicityByIntegrityPublicityId">
...
<script src="${pageContext.request.contextPath}/content/service/integrityPublicity/config.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/integrityPublicity/model.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/integrityPublicity/controller.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/integrityPublicity/view.js?version=${cfg.version}"></script>

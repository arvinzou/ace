        ...
        <div class="row custom-toolbar">
            <form action="#" id="fm-search" >
                <div class="col-md-5 toolbar">
                    <button type="button" class="btn  green" id="btn-view-add"  authority="${pageContext.request.contextPath}/integrityPublicity/insertIntegrityPublicity"></button>
                </div>
                <div class="col-md-3">
...
<script
        src="${pageContext.request.contextPath}/content/service/integrityPublicity/config.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/integrityPublicity/model.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/integrityPublicity/controller.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/integrityPublicity/view.js?version=${cfg.version}"></script>

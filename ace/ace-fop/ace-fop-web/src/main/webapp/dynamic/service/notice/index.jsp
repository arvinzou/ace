    ...
    <div class="portlet-body">
        ...
        <div class="row custom-toolbar">
            ...
            <div class="col-md-2 toolbar">
                ...
                <button type="button" class="btn  green" id="btn-view-add" authority="${pageContext.request.contextPath}/fopNotice/insertFopNotice"></button>
            ...
            <div class="col-md-7">
                ...
                <div class="btn-group" role="group"  style="float:right;padding-right:5px">
                    公告类型 <input class="easyui-combobox" style="width: 250px;height:30px" name="noticeType"
                                data-options="
...
<script
        src="${pageContext.request.contextPath}/content/service/notice/upload.js?version=${cfg.version}"></script>

...
<div class="page-content">
    ...
    <%--<h5 class="widget-title">月度筛选</h5>--%>
    <%--</div>--%>
    <%--<div class="widget-body">--%>
    <%--<div class="widget-main">--%>
    <%--<select role="select" id="companyProperty" name="companyProperty" size="1"--%>
    <%--class="FormElement ui-widget-content ui-corner-all">--%>
    <%--<option role="option" value=""></option>--%>
    <%--<option role="option" value="1">私营企业</option>--%>
    <%--<option role="option" value="2">港澳台商投资企业</option>--%>
    <%--<option role="option" value="3">外商投资企业</option>--%>
    <%--<option role="option" value="4">股份合作企业</option>--%>
    <%--<option role="option" value="5">其他联营企业</option>--%>
    <%--<option role="option" value="6">有限责任公司</option>--%>
    <%--<option role="option" value="7">股份有限公司</option>--%>
    <%--<option role="option" value="8">其他企业</option>--%>
    <%--</select>--%>
    <%--</div>--%>
    <%--</div>--%>
    <%--</div>--%>
...
<script src="${pageContext.request.contextPath}/content/service/analysis/serviceStatistics/config.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/analysis/serviceStatistics/controller.js?version=${cfg.version}"></script>

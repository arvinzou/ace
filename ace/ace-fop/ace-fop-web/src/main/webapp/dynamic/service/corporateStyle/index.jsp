    ...
    <div class="portlet-body">
        ...
        <div class="row custom-toolbar">
            <form action="#" id="fm-search" >
                ...
                <div class="col-md-3">
                    类别1：<input name="category" class="easyui-combobox" style="width: 200px"
                               data-options="
...
<script
        src="${pageContext.request.contextPath}/content/service/corporateStyle/config.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/corporateStyle/model.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/corporateStyle/controller.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/corporateStyle/view.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/corporateStyle/upload.js?version=${cfg.version}"></script>

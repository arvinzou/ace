            ...
            <form class="form-horizontal" id="fm-add" role="form">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea style="width: 600px; height: 50px; line-height: 30px;" id="telext"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
									<textarea style="width: 600px; height: 80px; line-height: 30px;" id="msg"
                                              maxLength="500" onkeyup="msgOnChange(this)"
                                              class="form-control"></textarea>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-7">
                                <button class="btn   green" type="submit" style="width:30%" id="btn-view-submit">发送
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <div class="tabbable">
                    <ul class="nav nav-tabs padding-16" id="myTab4">
                        ...
                        <li>
                            <a data-toggle="tab" id="tab-group-tmp" href="#tmp">
                    ...
                    <div class="tab-content">
                        <div id="dept" class="tab-pane in active">
                            <div id="tree-dept-panel" class="easyui-panel"
                                 style="padding: 5px; width: 1000px; height: 300px">
                                <ul id="tree-dept"></ul>
                            </div>
                        </div>

                        <div id="tmp" class="tab-pane">
                            <select class="easyui-combogrid" style="width:1000px; height: 25px; line-height: 25px;"
                                    id="combogrid-tmp"></select>
                            ...
                            <div style="height:5px"></div>
                            <div id="task-content-view" class="easyui-panel"
                                 style="padding: 5px; width: 1000px; height: 200px"></div>

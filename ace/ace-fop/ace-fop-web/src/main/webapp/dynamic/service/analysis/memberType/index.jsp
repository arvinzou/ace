...
<script src="${pageContext.request.contextPath}/content/service/analysis/memberType/config.js?version=${cfg.version}"></script>
<script src="${pageContext.request.contextPath}/content/service/analysis/memberType/controller.js?version=${cfg.version}"></script>

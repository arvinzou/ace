    ...
    $('#btn-view-audit').on(
        ...
        function (e) {
            ...
            var dialog = $("#dialog-message-audit").removeClass('hide').dialog({
                modal: true,
                width: 380,
                title: "<div class='widget-header widget-header-small'><h4 class='smaller'><i class='ace-icon fa fa-cog'></i> " + rowData.financeTitle + "</h4></div>",
                title_html: true,
                buttons: [
                    {
...
function preview(id, title) {
    window.open(contextPath + "/www/html/finance/finance_info.html?id=" + id);

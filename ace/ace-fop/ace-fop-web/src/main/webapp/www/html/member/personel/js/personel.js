...
app.controller(ngControllerName,function($scope){
    ...
    $.ajax({
        ...
        type:"post",
        async:false,
        data: {limit: pageSize, page: currentPage, modules: "3", iself: true},
        success:function(result){
            if(result.status == 0) {
    ...
    $scope.searchList = function(currentPage, pageSize, status){
        ...
        $.ajax({
            ...
            type:"post",
            async:false,
            data: {limit: pageSize, page: currentPage, modules: "3", status: status, iself: true},
    ...
    $scope.search = function(status){
        $.ajax({
            ...
            type:"post",
            async:false,
            data: {limit: pageSize, page: 1, modules: "3", status: status, iself: true},
            success:function(result){
                if(result.status == 0) {
                    $scope.items = result.data.list;
                    if (!$scope.$$phase) {

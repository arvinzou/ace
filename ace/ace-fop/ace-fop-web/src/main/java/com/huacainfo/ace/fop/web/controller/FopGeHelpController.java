...
public class FopGeHelpController extends FopBaseController {
    ...
    @ResponseBody
    public PageResult<FopGeHelpVo> findFopGeHelpList(FopGeHelpQVo condition,
                                                     PageParamNoChangeSord page) throws Exception {
        PageResult
                <FopGeHelpVo> rst = this.fopGeHelpService
                .findFopGeHelpList(condition, page.getStart(), page.getLimit(),
                        page.getOrderBy());
        if (rst.getTotal() == 0) {
    ...
    public MessageResponse insertFopGeHelp(String jsons) throws Exception {
        ...
        return this.fopGeHelpService
                .insertFopGeHelp(obj, this.getCurUserProp());
    }
    ...
    public MessageResponse deleteFopGeHelpByFopGeHelpId(String jsons) throws Exception {
        ...
        return this.fopGeHelpService.deleteFopGeHelpByFopGeHelpId(id,
                this.getCurUserProp());
    }
    ...
    public MessageResponse audit(String id) throws Exception {
        ...
        return fopGeHelpService.audit(id, getCurUserProp());
    }
}

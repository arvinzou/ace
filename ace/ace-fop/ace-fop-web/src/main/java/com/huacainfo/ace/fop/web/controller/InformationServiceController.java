...
public class InformationServiceController extends FopBaseController {
    ...
    @ResponseBody
    public PageResult
            <InformationServiceVo> findInformationServiceList(InformationServiceQVo condition, PageParamNoChangeSord page) throws Exception {
        PageResult
                <InformationServiceVo> rst = this.corporateStyleService

...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/cu/www/common/js/swiper/css/swiper.min.css?v=<%=System.currentTimeMillis()%>"/>
...
<div class="projectbox">
    <div class="project_item">
        <div class="project_item_image" style="height: 5.625rem;">
...
<script id="project-tpl" type="text/template">
    ...
    <div class="project_item_raise" style="display: none;">
        ...
        <div class="raise_01">
            ...
            {@else}
            <p  class="raise_money">\${(projectInfo.endDate).substring(0,10)}</p>
...
<script type="text/javascript" src="/cu/www/common/js/swiper/js/swiper.js?v=<%=System.currentTimeMillis()%>"></script>

...
app.controller(ngControllerName, function ($scope) {
    ...
    $scope.update = function (id) {
        ...
        $.ajax({
            ...
            data: {
                id: id,
                financeTitle: $scope.infoData.financeTitle,
                financeAmount: $scope.infoData.financeAmount,
                financeYear: $scope.infoData.financeYear,
                financeContent: content,
                yearYield: $scope.infoData.yearYield
            },
            success: function (result) {
                if (result.status == 0) {
                    $scope.search();
    ...
    $scope.release = function () {
        ...
        $.ajax({
            ...
            async: false,
            data: {
                financeTitle: financeName,
                financeAmount: financeMoney,

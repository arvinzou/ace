...
<div class="index">
    ...
    <div class="badding">
        <div class="phoneNum">
            <input type="text" name="mobile" id="mobile" placeholder="请输入手机号码" onfocus="this.placeholder=''"
                   onblur="this.placeholder='请输入手机号码'"/>
            <button id="getNumBtn" onclick="getNumFun();">获取验证码</button>
        </div>
        <div class="code">
            <input type="text" name="codeNum" id="codeNum" placeholder="请输入验证码" onfocus="this.placeholder=''"

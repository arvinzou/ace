...
public class CuUser implements Serializable {
    ...
    public BigDecimal getHisPoints() {
        return hisPoints;
    }

    public void setHisPoints(BigDecimal hisPoints) {
        this.hisPoints = hisPoints;
    }

    public BigDecimal getCurPoints() {
        return curPoints;
    }

    public void setCurPoints(BigDecimal curPoints) {

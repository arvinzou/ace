package com.huacainfo.ace.generator.cu;
...
public class AutoCode {
    ...
    public static void main(String[] args) throws Exception {
        AutoCodeUtils autoCodeUtils = new AutoCodeUtils("cu", "捐献记录", "Arvin");
//        Class<?> c = com.huacainfo.ace.cu.model.CuDonateList.class;
        Class<?> c = null;

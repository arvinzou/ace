...
public class CodeGenerator {
    ...
    public void generatorJavaController(Class c) throws Exception {
        String cName = c.getName();
        String path = webws + "/src/main/java/" + this.getProperty("package.controller") + "/";
    ...
    public void generatorJavaVO(Class c) throws Exception {
        String cName = c.getName();
        String path = clientws + "/src/main/java/" + this.getProperty("package.vo") + "/";
        File filePath = new File(path);
        createFilePath(filePath);
    ...
    public void generatorJavaDAO(Class c) throws Exception {
        String cName = c.getName();
        String path = serverws + "/src/main/java/" + this.getProperty("package.dao") + "/";
        File filePath = new File(path);
        createFilePath(filePath);
    ...
    public void generatorJavaService(Class c) throws Exception {
        String cName = c.getName();
        String path = clientws + "/src/main/java/" + this.getProperty("package.service") + "/";
        File filePath = new File(path);
        createFilePath(filePath);
    ...
    private void createFilePath(File file) {
        if (!file.exists()) {
           logger.info("创建[" + file.getAbsolutePath() + "]情况：" + file.mkdirs());
        } else {
           logger.info("存在目录：" + file.getAbsolutePath());
        }
    }
    ...
    public void generatorIndexDir(Class c) throws Exception {
        /**创建根目录**/
        String pathRoot = webws + "/src/main/webapp/dynamic/service/" + lowerCase(c.getSimpleName()) + "/";
        ...
        /**创建CSS目录**/
        String pathCss = webws + "/src/main/webapp/dynamic/service/" + lowerCase(c.getSimpleName()) + "/css/";
        ...
        /**创建IMG目录**/
        String pathImg = webws + "/src/main/webapp/dynamic/service/" + lowerCase(c.getSimpleName()) + "/img/";
        File filePathImg = new File(pathImg);
        createFilePath(filePathImg);


        /**创建JS目录**/
        String pathJs = webws + "/src/main/webapp/dynamic/service/" + lowerCase(c.getSimpleName()) + "/js/";
    ...
    public void generatorAddDir(Class c) throws Exception {
        /**创建根目录**/
        String pathRoot = webws + "/src/main/webapp/dynamic/service/" + lowerCase(c.getSimpleName()) + "/add/";
        File filePathRoot = new File(pathRoot);
        createFilePath(filePathRoot);
        ...
        /**创建CSS目录**/
        String pathCss = webws + "/src/main/webapp/dynamic/service/" + lowerCase(c.getSimpleName()) + "/add/css/";
        File filePathCss = new File(pathCss);
        createFilePath(filePathCss);
        String fileNameCss = pathCss + "style.css";
        File fileCss = new File(fileNameCss);
        ...
        /**创建IMG目录**/
        String pathImg = webws + "/src/main/webapp/dynamic/service/" + lowerCase(c.getSimpleName()) + "/add/img/";
        File filePathImg = new File(pathImg);
        createFilePath(filePathImg);
    ...
    public void generatorEditDir(Class c) throws Exception {
        ...
        /**创建CSS目录**/
        String pathCss = webws + "/src/main/webapp/dynamic/service/" + lowerCase(c.getSimpleName()) + "/edit/css/";
        File filePathCss = new File(pathCss);
        createFilePath(filePathCss);
        String fileNameCss = pathCss + "style.css";
        File fileCss = new File(fileNameCss);
        ...
        /**创建IMG目录**/
        String pathImg = webws + "/src/main/webapp/dynamic/service/" + lowerCase(c.getSimpleName()) + "/edit/img/";
        File filePathImg = new File(pathImg);
        createFilePath(filePathImg);

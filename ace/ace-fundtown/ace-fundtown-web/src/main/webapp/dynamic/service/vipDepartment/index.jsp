            ...
            <form action="#" id="fm-search">
                <div class="col-md-5 toolbar">
                    ...
                    <button type="button" class="btn  green" id="btn-view-add"
                            authority="${pageContext.request.contextPath}/vipDepartment/insertVipDepartment"></button>

                </div>
                <div class="col-md-7">
                    <div class="input-group" role="group" style="float:left;padding-right:10px">
                        企业类型 <input name="type" class="easyui-combobox"
                                    style="width: 200px;height: 30px;line-height: 30px;"
                                    data-options="url:'${portalPath}/dict/findListByCategoryId.do?categoryId=147&selected=false',
                                 method:'get',
                                 valueField:'code',
                                 textField:'name',
                                 panelHeight:'auto'">

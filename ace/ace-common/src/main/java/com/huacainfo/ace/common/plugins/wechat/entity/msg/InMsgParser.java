 ...
 * file name:InMsgParser
 * package name:com.arvin.wechat.pojo.msg
 * date:2016-07-27 11:48
 * author:Administrator
 * Copyright (c) CD Technology Co.,Ltd. All rights reserved.
 */
package com.huacainfo.ace.common.plugins.wechat.entity.msg;


import com.huacainfo.ace.common.plugins.wechat.entity.msg.in.*;
import com.huacainfo.ace.common.plugins.wechat.entity.msg.in.event.*;
import com.huacainfo.ace.common.plugins.wechat.entity.msg.in.speech_recognition.InSpeechRecognitionResults;
...
public class InMsgParser {
    ...
    private static InMsg parseInEvent(Element root, String toUserName, String fromUserName, Integer createTime, String msgType) {
        ...
        if (("subscribe".equals(event) || "unsubscribe".equals(event))
                && (StringUtils.isEmpty(eventKey) || eventKey.startsWith("last_trade_no_"))) {
        ...
        if ("subscribe".equals(event) && StringUtils.isNotEmpty(eventKey) && eventKey.startsWith("qrscene_")) {
            //if ("subscribe".equals(event) && StringUtil.notBlank(eventKey)) {
            InQrCodeEvent e = new InQrCodeEvent(toUserName, fromUserName, createTime, msgType, event);
            e.setEventKey(eventKey);
            e.setTicket(XmlKit.elementText(root, "Ticket"));
            return e;
        }

...
public class IDCardUtil {
    ...
    public static String getNativeCode(String CardCode)
            throws Exception {
        return  CardCode.substring(0,6);
    }

    public static Date getbirthDay(String CardCode, String format)
            throws Exception {
        ...
        return sdf.parse(year+format+yue+format+day);
    }


    public static String getSexCode(String CardCode)
            throws Exception {
        String sex;

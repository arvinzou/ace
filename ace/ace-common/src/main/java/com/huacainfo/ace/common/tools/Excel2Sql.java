...
public class Excel2Sql {
    ...
    private static final String SRC_FILE_PATH = "C:\\Users\\HuaCai008\\Desktop\\心阳光健康联盟平台数据模型v1.6.xls";
    private static final String OUT_FILE_PATH = "C:\\Users\\HuaCai008\\Desktop\\sql.sql";
    ...
    public static void main(String[] args) throws Exception {
        ...
        java.io.File fileOut = new java.io.File(OUT_FILE_PATH);

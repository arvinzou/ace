jQuery(function ($) {
    ...
    jQuery("#alldevice-grid-table").jqGrid({
        prmNames: {
            totalRecord: "totalRecord",
            start: "start",
            page: "page",
        ...
        datatype: "json",
        url: contextPath + "/device/findDeviceList",
        jsonReader: {
            root: "rows",
            page: "page",
            total: "totalPages",
    ...
    jQuery("#mydevice-grid-table").jqGrid({
        prmNames: {
            totalRecord: "totalRecord",
            start: "start",
            page: "page",
        ...
        caption: '已分配',
        loadComplete: function () {
            $("#mydevice-grid-table").jqGrid('setGridWidth', $("#mydevice-grid-table").width());
        }
    });

                    ...
                    panelHeight:'auto'">
                     ...
                     名称： <input name="name" type="text"
						...
						<button class="btn btn-info" id="btn-search"
							authority="${pageContext.request.contextPath}/trafficIllegal/findTrafficIllegalList">
							 <i
...
<span id="lastModifyDate">
	...
	<script
		src="${pageContext.request.contextPath}/content/service/trafficIllegal/config.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/trafficIllegal/model.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/trafficIllegal/controller.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/trafficIllegal/view.js?version=${cfg.version}"></script>

				...
				类别：<input
                    ...
                    panelHeight:'auto'">
                     ...
                     名称： <input name="name" type="text"
						...
						<button class="btn btn-info" id="btn-search"
							authority="${pageContext.request.contextPath}/vehicle/findVehicleList.do">
							 <i
					...
					<div id="toolbar" class="toolbar">
						...
						<button class="btn btn-info" id="btn-view-add"
							authority="${pageContext.request.contextPath}/vehicle/insertVehicle.do">
							 <i
								class="ace-icon fa fa-plus-square  align-middle bigger-125 icon-on-right"></i>
						</button>
						<button class="btn btn-info" id="btn-view-edit"
							authority="${pageContext.request.contextPath}/vehicle/updateVehicle.do">
							 <i
								class="ace-icon fa fa-edit  align-middle bigger-125 icon-on-right"></i>
						</button>
						<button class="btn btn-warning" id="btn-view-del"
							authority="${pageContext.request.contextPath}/vehicle/deleteVehicleByVehicleId.do">
							 <i

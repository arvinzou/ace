...
<div id="dialog-message-view" class="hide">
    ...
    <div class="row" style="padding:10px">
        ...
        <div class="labelItem">
            <span class="labelItemHeader">所属人</span>
            <br>
            <span id="personId" class="hide"></span>
            <span id="personName"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">所属车辆</span>
            <br>
        ...
        <div class="labelItem">
            <span class="labelItemHeader">黑名生效时间</span>
            <br>
            <span id="effectDate"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">黑名生效原因</span>
            <br>
            <span id="effectReason"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">黑名失效时间</span>
            <br>
            <span id="lapseDate"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">黑名生效原因</span>
            <br>
        ...
        <div class="labelItem">
            <span class="labelItemHeader">是否黑名单</span>
            <br>
            <span id="isBlack"></span>
        </div>
        <div class="labelItem">

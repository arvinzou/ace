...
<div id="dialog-message-view" class="hide">
    ...
    <div class="row" style="padding:10px">
        <div class="labelItem">
            <span class="labelItemHeader">卡点名称</span>
            <br>
            <span id="siteName"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">卡点编码</span>
            <br>
        ...
        <div class="labelItem">
            <span class="labelItemHeader">车道数</span>
            <br>
            <span id="roadwayNum"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">检测点数量</span>
            <br>
            <span id="checkpointsNum"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">卡点地址</span>
            <br>
            <span id="address"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">纬度</span>
            <br>
        ...
        <div class="labelItem">
            <span class="labelItemHeader">建造单位</span>
            <br>
            <span id="buildDeptName"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">所在道路</span>
            <br>
            <span id="roadName"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">管辖单位</span>
            <br>
            <span id="adminDeptName"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">卡点运行状态</span>
            <br>
            <span id="sitStatus"></span>
        </div>
        <div class="labelItem">
...
<script
        src="${pageContext.request.contextPath}/content/service/site/config.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/site/model.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/site/controller.js?version=${cfg.version}"></script>
<script
        src="${pageContext.request.contextPath}/content/service/site/view.js?version=${cfg.version}"></script>

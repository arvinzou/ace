...
<div id="dialog-message-view" class="hide">
    ...
    <div class="row" style="padding:10px">
        ...
        <div class="labelItem">
            <span class="labelItemHeader">设备名称</span>
            <br>
            <span id="deviceName"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">设备编号</span>
            <br>
            <span id="deviceNo"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">设备类型</span>
            <br>
            <span id="deviceType"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">设备状态</span>
            <br>
            <span id="deviceStatus"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">设备上线日期</span>
            <br>
            <span id="onlineDate"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">设备下线日期</span>
            <br>
            <span id="offlineDate"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">制造厂商</span>
            <br>
            <span id="manufacturer"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">出厂日期</span>
            <br>
            <span id="manufactureDate"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">制造商联系人</span>
            <br>
            <span id="contactName"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">制造商联系电话</span>
            <br>
            <span id="contactPhoneNumber"></span>
        </div>
        <div class="labelItem">
            <span class="labelItemHeader">设备IP地址</span>
            <br>
            <span id="ipAddr"></span>
        </div>
        <div class="labelItem">

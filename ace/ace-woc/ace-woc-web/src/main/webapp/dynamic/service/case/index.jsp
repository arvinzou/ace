...
<span id="lastModifyDate">
	...
	<script
		src="${pageContext.request.contextPath}/content/service/case/config.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/case/model.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/case/controller.js?version=${cfg.version}"></script>
	<script
		src="${pageContext.request.contextPath}/content/service/case/view.js?version=${cfg.version}"></script>

...
public interface SeRouteStateService {
     ...
     * @version: 2019-04-18
     */
    PageResult<SeRouteStateVo> findSeRouteStateList(SeRouteStateQVo condition, int start, int limit, String orderBy) throws Exception;
     ...
     * @version: 2019-04-18
     */
    SingleResult<SeRouteStateVo> selectSeRouteStateByPrimaryKey(String id) throws Exception;

...
public interface SePresetDataService {
     ...
     * @version: 2019-04-18
     */
    PageResult<SePresetDataVo> findSePresetDataList(SePresetDataQVo condition, int start, int limit, String orderBy) throws Exception;
     ...
     * @version: 2019-04-18
     */
    SingleResult<SePresetDataVo> selectSePresetDataByPrimaryKey(String id) throws Exception;

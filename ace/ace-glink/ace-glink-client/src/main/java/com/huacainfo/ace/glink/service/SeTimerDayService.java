 ...
 */
public interface SeTimerDayService {
    /**
     * @throws
     ...
     * @version: 2019-04-19
     */
    MessageResponse insertSeTimerDay(SeTimerDay obj, UserProp userProp) throws Exception;
     ...
     * @version: 2019-04-19
     */
    MessageResponse updateSeTimerDay(SeTimerDay obj, UserProp userProp) throws Exception;
     ...
     * @version: 2019-04-19
     */
    MessageResponse deleteSeTimerDayBySeTimerDayId(String id, UserProp userProp) throws Exception;
     ...
     * @version: 2019-04-19
     */
    MessageResponse deleteSeTimerDayBySeTimerDayIds(String[] id, UserProp userProp) throws Exception;

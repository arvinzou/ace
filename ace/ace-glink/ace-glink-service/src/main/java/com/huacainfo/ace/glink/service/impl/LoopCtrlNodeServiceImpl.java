...
import com.huacainfo.ace.glink.dao.LoopCtrlNodeDao;
...
@Service("loopCtrlNodeService")
/**
 * @author: heshuang
 * @version: 2019-04-15
 * @Description: TODO(区级整体控制)
 */
public class LoopCtrlNodeServiceImpl implements LoopCtrlNodeService {
    Logger logger = LoggerFactory.getLogger(this.getClass());
    @Autowired
    private LoopCtrlNodeDao loopCtrlNodeDao;
    @Autowired
    ...
    public PageResult
        ...
        PageResult
                <LoopCtrlNodeVo> rst = new PageResult<>();
        List
                <LoopCtrlNodeVo> list = loopCtrlNodeDao.findList(condition, start, limit, orderBy);
        rst.setRows(list);
        if (start <= 1) {
            int allRows = this.loopCtrlNodeDao.findCount(condition);
     ...
     */
    @Override
    public MessageResponse insertLoopCtrlNode(LoopCtrlNode o, UserProp userProp) throws Exception {
        ...
        int temp = this.loopCtrlNodeDao.isExit(o);
        if (temp > 0) {
     ...
     */
    @Override
    public MessageResponse updateLoopCtrlNode(LoopCtrlNode o, UserProp userProp) throws Exception {
        if (CommonUtils.isBlank(o.getId())) {
            return new MessageResponse(1, "主键不能为空！");
        }
        if (CommonUtils.isBlank(o.getNodeCode())) {
        ...
        this.loopCtrlNodeDao.updateByPrimaryKey(o);
    ...
    public SingleResult
        ...
        SingleResult
                <LoopCtrlNodeVo> rst = new SingleResult<>();
        rst.setValue(this.loopCtrlNodeDao.selectVoByPrimaryKey(id));
        return rst;
    }
     ...
     */
    @Override
    public MessageResponse deleteLoopCtrlNodeByLoopCtrlNodeId(String id, UserProp userProp) throws
            Exception {
        this.loopCtrlNodeDao.deleteByPrimaryKey(id);
    ...
    public MessageResponse importXls(List
        ...
        for (Map
                <String
                        , Object> row : list) {
            LoopCtrlNode o = new LoopCtrlNode();
            ...
            int t = this.loopCtrlNodeDao.isExit(o);
            if (t > 0) {
                this.loopCtrlNodeDao.updateByPrimaryKey(o);
    ...
    public ListResult<Map<String, Object>> getList(Map<String, Object> p) throws Exception {
        ...
        rst.setValue(this.loopCtrlNodeDao.getList(p));
    ...
    public Map<String, Object> getListByCondition(Map<String, Object> params) {
        ...
        List<Map<String, Object>> list = this.loopCtrlNodeDao.getListByCondition(params);
     ...
     */
    @Override
    public MessageResponse deleteLoopCtrlNodeByLoopCtrlNodeIds(String[] id, UserProp userProp)
            throws Exception {

        this.loopCtrlNodeDao.deleteByPrimaryKeys(id);
    ...
    public MessageResponse updateStatus(String id, String status, UserProp userProp) throws
            Exception {
        this.loopCtrlNodeDao.updateStatus(id, status);
    ...
    public MessageResponse updateState(String id, String state) throws Exception {
        this.loopCtrlNodeDao.updateState(id, state);
        return new MessageResponse(0, "成功！");
    }

...
(function () {
        ...
        ;var Ub = {
            //修改，这里是所有的模块，用到时自动加载（在线），离线的话要先下载下来放到本地，
            // 如http://api0.map.bdimg.com/getmodules?v=3.0&mod=模块1,模块2
            ...
            CI: function (a) {
                ...
                for (var i = 0; i < c; i++) {
                    ...
                    if (!k.pI && !(k.pp && !this.map.Sb() || k.GM && this.map.Sb())) {
                        ...
                        var E = this.yg, y = -this.gK.lng / v, A = this.gK.lat / v, v = [Math.ceil(y), Math.ceil(A)],
                            g = e.fa(), C;
                        for (C in E) {
                            var F = E[C]
                                , D = F.info;

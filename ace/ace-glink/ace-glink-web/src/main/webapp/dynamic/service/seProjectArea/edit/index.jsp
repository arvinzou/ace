...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="projectName"
                       value="\{data.o.projectName}" maxlength="50"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="areaName"
                       value="\{data.o.areaName}" maxlength="100"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="areaNodeCount"
                       value="\{data.o.areaNodeCount}" maxlength="50"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="areaType"
                       value="\{data.o.areaType}" maxlength="1"

...
var url = contextPath+ "/ammeterNode/findAmmeterNodeList";
...
/*查看详情*/
function detail(id) {
var url = contextPath + "/ammeterNode/selectAmmeterNodeByPrimaryKey";
...
startLoad();
$.ajax({
url: contextPath + "/ammeterNode/audit",
type:"post",
async:false,
data:params,
...
startLoad();
$.ajax({
url: contextPath + "/ammeterNode/updateStatus",
type:"post",
async:false,
data:{
id :id,

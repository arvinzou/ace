...
<script id="tpl-fm-add" type="text/template">
    <form class="form-horizontal" id="fm-add" role="form">
        <div class="form-body">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="stopDate" maxlength=""
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="specialDate" maxlength=""
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="startTime" maxlength=""
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="stopTime" maxlength=""

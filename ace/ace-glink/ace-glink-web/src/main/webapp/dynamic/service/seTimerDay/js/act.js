...
function getPageList() {
    var url = contextPath + "/seTimerDay/findSeTimerDayList";
...
/*查看详情*/
function detail(id) {
    var url = contextPath + "/seTimerDay/selectSeTimerDayByPrimaryKey";
...
function audit(params) {
    startLoad();
    $.ajax({
        url: contextPath + "/seTimerDay/audit",
        type: "post",
        async: false,
        data: params,
...
function online(id) {
    if (confirm("确定要上架吗？")) {
        startLoad();
        $.ajax({
            url: contextPath + "/seTimerDay/updateStatus",
            type: "post",
            async: false,
            data: {
                id: id,
...
﻿function initPreview(id) {
    startLoad();
    $.ajax({
        url: contextPath + "/seTimerDay/selectSeTimerDayByPrimaryKey",
        type: "post",
        async: false,
        data: {
            id: id

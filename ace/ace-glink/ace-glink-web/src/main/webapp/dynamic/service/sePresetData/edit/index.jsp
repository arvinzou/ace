...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="presetNo"
                               value="\{data.o.presetNo}" maxlength="10"
                               placeholder="请输入场景编号（建议字数在14个字以内，不超过10个字)">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="presetName"
                               value="\{data.o.presetName}" maxlength="50"

...
/*查看详情*/
function detail(id) {
    var url = contextPath + "/topStation/selectTopStationByPrimaryKey";
...
function audit(params) {
    startLoad();
    $.ajax({
        url: contextPath + "/topStation/audit",
        type: "post",
        async: false,
        data: params,
...
function online(id) {
    if (confirm("确定要上架吗？")) {
        startLoad();
        $.ajax({
            url: contextPath + "/topStation/updateStatus",
            type: "post",
            async: false,
            data: {
                id: id,
...
function del(id) {
    if (confirm("确定要删除吗？")) {
        startLoad();
        $.ajax({
            url: contextPath + "/topStation/deleteTopStationByTopStationId",
            type: "post",
            async: false,
            data: {
                id: id,

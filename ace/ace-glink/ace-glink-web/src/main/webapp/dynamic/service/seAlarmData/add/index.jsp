...
<script id="tpl-fm-add" type="text/template">
    <form class="form-horizontal" id="fm-add" role="form">
        <div class="form-body">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="alarmType" maxlength="50"
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="alarmContent" maxlength="200"
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="alarmDateTime" maxlength="50"

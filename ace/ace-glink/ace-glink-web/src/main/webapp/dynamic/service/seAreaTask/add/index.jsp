    ...
    <form class="form-horizontal" id="fm-add" role="form">
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="taskNo" maxlength="51"
                           placeholder="请输入任务号（建议字数在14个字以内，不超过51个字)">
                    <span class="help-block"></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="taskName" maxlength="52"
                           placeholder="请输入任务名称（建议字数在14个字以内，不超过52个字)">
                    <span class="help-block"></span>
                </div>
            </div>
            <div class="form-group">

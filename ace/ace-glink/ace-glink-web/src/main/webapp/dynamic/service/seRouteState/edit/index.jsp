...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="signal"
                               value="\{data.o.signal}" maxlength="50"
                               placeholder="请输入信号强度，离线时为空（建议字数在14个字以内，不超过50个字)">
                        <span class="help-block"></span>
                    </div>
                </div>
                            <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="updateTime"
                               value="\{data.o.updateTime}" maxlength="20"
                               placeholder="请输入状态更新时间（建议字数在14个字以内，不超过20个字)">
                        <span class="help-block"></span>
                    </div>
                </div>
                            <div class="form-group">

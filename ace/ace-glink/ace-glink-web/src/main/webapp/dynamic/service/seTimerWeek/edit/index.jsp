...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="w6"
                       value="\{data.o.w6}" maxlength="10"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="w7"
                       value="\{data.o.w7}" maxlength="10"

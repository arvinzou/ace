...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="nodeCount"
                       value="\{data.o.nodeCount}" maxlength="10"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="nodeID"
                       value="\{data.o.nodeID}" maxlength="10"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="local"
                       value="\{data.o.local}" maxlength="50"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="iPAddress"
                       value="\{data.o.iPAddress}" maxlength="50"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="routeIPAddress"
                       value="\{data.o.routeIPAddress}" maxlength="50"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="meterID"
                       value="\{data.o.meterID}" maxlength="50"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="meterType"
                       value="\{data.o.meterType}" maxlength="50"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="engineer"
                       value="\{data.o.engineer}" maxlength="50"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="deviceCount"
                       value="\{data.o.deviceCount}" maxlength="10"

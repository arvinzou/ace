...
page: "
<li class="page"><a href="javascript:;">{{page}}</a></li>",
...
var url = contextPath+ "/sceneExecutor/findSceneExecutorList";
...
/*查看详情*/
function detail(id) {
var url = contextPath + "/sceneExecutor/selectSceneExecutorByPrimaryKey";
...
startLoad();
$.ajax({
url: contextPath + "/sceneExecutor/audit",
type:"post",
async:false,
data:params,
...
startLoad();
$.ajax({
url: contextPath + "/sceneExecutor/updateStatus",
type:"post",
async:false,
data:{
id :id,

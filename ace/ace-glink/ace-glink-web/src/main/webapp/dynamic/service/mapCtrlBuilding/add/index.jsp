...
<script id="tpl-fm-add" type="text/template">
    <form class="form-horizontal" id="fm-add" role="form" style="width:90%;">
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="ctrlCode" maxlength="50"
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="ctrlName" maxlength="50"
                           placeholder="请输入控制器编码（建议字数在14个字以内，不超过50个字)">
                    <span class="help-block"></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="buildingCode" maxlength="50"
                           placeholder="请选择建筑物" style="width:450px">
                    <span class="help-block"></span>
                </div>
            </div>
            <div class="form-group">

...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="aiCode"
                               value="\{data.o.aiCode}" maxlength="20"
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="lnkCode"
                               value="\{data.o.lnkCode}" maxlength="50"
                               placeholder="请输入建筑/节点/站点编码（建议字数在14个字以内，不超过50个字)">
                        <span class="help-block"></span>
                    </div>
                </div>
                            <div class="form-group">
...
1-站点；2-节点；3-建筑
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="lnkType"
                               value="\{data.o.lnkType}" maxlength="1"
                               placeholder="请输入关联编码类型
1-站点；2-节点；3-建筑（建议字数在14个字以内，不超过1个字)">
                        <span class="help-block"></span>
                    </div>
                </div>
                            <div class="form-group">

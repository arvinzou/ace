...
function getPageList() {
    var url = contextPath + "/seAlarmData/findSeAlarmDataList";
    params['alarmContent'] = $("input[name=keyword]").val();
    startLoad();
...
/*查看详情*/
function detail(id) {
    var url = contextPath + "/seAlarmData/selectSeAlarmDataByPrimaryKey";
...
﻿function initPreview(id) {
    startLoad();
    $.ajax({
        url: contextPath + "/seAlarmData/selectSeAlarmDataByPrimaryKey",
        type: "post",
        async: false,
        data: {
            id: id

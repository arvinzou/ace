...
<script id="tpl-fm-add" type="text/template">
    <form class="form-horizontal" id="fm-add" role="form">
        <div class="form-body">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="aiCode" maxlength="20"
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="lnkCode" maxlength="50"
...
1-站点；2-节点；3-建筑
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="lnkType" maxlength="1"

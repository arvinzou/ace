...
function getPageList() {
    var url = contextPath + "/seRouteState/findSeRouteStateList";
...
/*查看详情*/
function detail(id) {
    var url = contextPath + "/seRouteState/selectSeRouteStateByPrimaryKey";
...
function audit(params) {
    startLoad();
    $.ajax({
        url: contextPath + "/seRouteState/audit",
        type: "post",
        async: false,
        data: params,
...
function online(id) {
    if (confirm("确定要上架吗？")) {
        startLoad();
        $.ajax({
            url: contextPath + "/seRouteState/updateStatus",
            type: "post",
            async: false,
            data: {
                id: id,
...
function syncData() {
    var  url=contextPath+'/seRouteState/syncData'

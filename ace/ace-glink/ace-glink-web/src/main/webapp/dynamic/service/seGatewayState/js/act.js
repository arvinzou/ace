...
$('#fm-search').ajaxForm({
    ...
    function getPageList() {
        var url = contextPath + "/seGatewayState/findSeGatewayStateList";
    ...
    /*查看详情*/
    function detail(id) {
        var url = contextPath + "/seGatewayState/selectSeGatewayStateByPrimaryKey";
    ...
    function audit(params) {
        startLoad();
        $.ajax({
            url: contextPath + "/seGatewayState/audit",
            type: "post",
            async: false,
            data: params,
    ...
    function online(id) {
        if (confirm("确定要上架吗？")) {
            startLoad();
            $.ajax({
                url: contextPath + "/seGatewayState/updateStatus",
                type: "post",
                async: false,
                data: {
                    id: id,
...
﻿function initPreview(id) {
        startLoad();
        $.ajax({
            url: contextPath + "/seGatewayState/selectSeGatewayStateByPrimaryKey",
            type: "post",
            async: false,
            data: {
                id: id

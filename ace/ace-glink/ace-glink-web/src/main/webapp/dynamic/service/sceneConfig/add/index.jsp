...
<script id="tpl-fm-add" type="text/template">
    <form class="form-horizontal" id="fm-add" role="form">
        <div class="form-body">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="weeks" maxlength="20"
                                   placeholder="请输入执行周期(数组)（建议字数在14个字以内，不超过20个字)">
                            <span class="help-block"></span>
                        </div>
                    </div>
                                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="startDate" maxlength=""
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" name="endDate" maxlength=""

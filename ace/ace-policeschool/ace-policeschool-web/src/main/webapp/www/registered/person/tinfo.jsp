...
<script id="option-tpl" type="text/template">
    <div class="info">
        ...
        <div class="icontent" id="bindWx">
            ...
            <form action="${pageContext.request.contextPath}/www/oauth2/auth" id="bindForm" method="post"
                ...
                <input type="hidden" value="/policeschool/www/registered/person/tinfo.jsp" id="respUri" name="respUri"/>
    ...
    <div class="info">
        ...
        <div class="icontent" onclick="editPassword();"><span class="bindLink">修改密码</span><img class="redirect"
                                                                                               src="img/icon_select.png"/>
        </div>
    </div>
</script>

        ...
        seekParameter: function (url, paraname) {
            ...
            for (var i = 0; i < whArray.length; i++) {
                ...
                if (yhArray.length == 1) {
                    ...
                    //===============
                    //以=分割数组抽取
                    if (yhArray == undefined || yhArray[0] == undefined || yhArray[0].indexOf('=') == -1) {
                        continue;
                    }
                    var dhArray = yhArray[0].split('=');
                    if (dhArray == undefined || dhArray.length == 1) {
                        continue;
                    }
                                        ...
                                        case "INPUT":
                                            ...
                                            switch (eType) {
                                                case "text":
                                                    ...
                                                    break;
                                                case "checkbox":
                                                    jText[item] == "true" ? $(eID).attr("checked", "checked") : $(eID).attr("checked", false);
                                                    break;
                                            }
                                            break;
                                        case "LABEL":

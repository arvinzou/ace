/* Zepto v1.2.0-25-gd7e4caf - zepto event ajax form fx fx_methods touch - zeptojs.com/license */
!
function(t, e) {
...
function(t) {
    var e = function() {
        ...
        i.contains = fcumentElement.contains ?
        function(t, e) {
        ...
        i.map = function(t, e) {
            var n, r, o, i = [];
            if (Z(t)) for (r = 0; r < t.length; r++) n = e(t[r], r),
            null != n && i.push(n);
        ...
        i.fn = {
            ...
            ready: function(e) {
                if ("complete" === f.readyState || "loading" !== f.readyState && !fcumentElementScroll) setTimeout(function() {
                    e(i)
                },
                0);
                else {
            ...
            filter: function(t) {
                return A(t) ? this.not(this.not(t)) : i(a.call(this,
                function(e) {
            ...
            attr: function(t, i) {
                ...
                return "string" != typeof t || 1 in arguments ? this.each(function(e) {
                    if (1 === this.nodeType) if (k(t)) for (n in t) W(this, n, t[n]);
            ...
            prop: function(t, e) {
                ...
                "string" != typeof t || 1 in arguments ? this.each(function(i) {
                    if (k(t)) for (n in t) this[M[n] || n] = t[n];
            ...
            offset: function(e) {
                ...
                if (fcumentElement !== this[0] && !i.contains(fcumentElement, this[0])) return {
                    top: 0,
                    left: 0
                };
            ...
            css: function(t, e) {
                ...
                else for (n in t) t[n] || 0 === t[n] ? a += I(n) + ":" + X(n, t[n]) + ";": this.each(function() {
            ...
            removeClass: function(t) {
                return this.each(function(n) {
                    if ("className" in this) {
                        ...
                        r = G(this),
                        J(this, t, n, r).split(/\s+/g).forEach(function(t) {
                            r = r.replace(q(t), " ")
                        }),
                        G(this, r.trim())
                    }
        ...
        ["width", "height"].forEach(function(t) {
            ...
            i.fn[t] = function(r) {
                var o, s = this[0];
                return r === e ? $(s) ? s["inner" + n] : F(s) ? scumentElement["scroll" + n] : (o = this.offset()) && o[t] : this.each(function(e) {
                    s = i(this),
                    s.css(t, J(this, r, e, s[t]()))
                })
            }
        }),
        x.forEach(function(n, r) {
            ...
            i.fn[n] = function() {
                ...
                return s.length < 1 ? this: this.each(function(e, n) {
                    ...
                    var c = i.contains(fcumentElement, a);
        ...
        C.Z.prototype = V.prototype = i.fn,
        C.uniq = P,
    ...
    function(e) {
        ...
        function b() {
            p && (e(document).off(hwn, f).off(h.up, c).off(h.move, l).off(h.cancel, v), e(t).off("scroll", v), v(), p = !1)
        }
        function w(w) {
            var E, T, C, N, j = 0,
            S = 0;
            ...
            h && ("MSGesture" in t && (u = new MSGesture, u.target = document.body, e(document).bind("MSGestureEnd",
            function(t) {
                var e = t.velocityX > 1 ? "Right": t.velocityX < -1 ? "Left": t.velocityY > 1 ? "Down": t.velocityY < -1 ? "Up": null;
                e && (n.el.trigger("swipe"), n.el.trigger("swipe" + e))
            })), f = function(t) { (!(N = x(t, "down")) || y(t)) && (C = N ? t: t.touches[0], t.touches && 1 === t.touches.length && n.x2 && (n.x2 = void 0, n.y2 = void 0), E = Date.now(), T = E - (n.last || E), n.el = e("tagName" in C.target ? C.target: C.target.parentNode), i && clearTimeout(i), n.x1 = C.pageX, n.y1 = C.pageY, T > 0 && 250 >= T && (n.isDoubleTap = !0), n.last = E, s = setTimeout(m, a), u && N && u.addPointer(t.pointerId))
            },
            l = function(t) { (!(N = x(t, "move")) || y(t)) && (C = N ? t: t.touches[0], g(), n.x2 = C.pageX, n.y2 = C.pageY, j += Math.abs(n.x1 - n.x2), S += Math.abs(n.y1 - n.y2))
            },
            c = function(t) { (!(N = x(t, "up")) || y(t)) && (g(), n.x2 && Math.abs(n.x1 - n.x2) > 30 || n.y2 && Math.abs(n.y1 - n.y2) > 30 ? o = setTimeout(function() {
                    n.el && (n.el.trigger("swipe"), n.el.trigger("swipe" + d(n.x1, n.x2, n.y1, n.y2))),
                    n = {}
                },
            ...
            e(document).on(h.up, c).on(hwn, f).on(h.move, l), e(document).on(h.cancel, v), e(t).on("scroll", v), p = !0)
        }
        var i, r, o, s, u, f, c, l, h, n = {},
        a = 750,
        p = !1; ["swipe", "swipeLeft", "swipeRight", "swipeUp", "swipeDown", "doubleTap", "tap", "singleTap", "longTap"].forEach(function(t) {
            e.fn[t] = function(e) {
                return this.on(t, e)
            }
        }),

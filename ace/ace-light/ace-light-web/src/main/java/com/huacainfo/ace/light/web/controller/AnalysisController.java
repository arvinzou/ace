...
import com.huacainfo.ace.light.service.AnalysisService;
...
public class AnalysisController extends LightBaseController {
    private static final long serialVersionUID = 1L;
    Logger logger = LoggerFactory.getLogger(LightBaseController.class);
    @Autowired

...
import com.huacainfo.ace.taa.service.AnalysisService;
...
public class AnalysisController extends TaaBaseController {
    private static final long serialVersionUID = 1L;
    Logger logger = LoggerFactory.getLogger(TaaBaseController.class);
    @Autowired

		...
		<div class="form-body">
									<div class="form-group">
										<div class="form-group">
											...
											<div class="col-md-5">
												<input type="text" class="form-control" name="address" value="\${data.o.address}" maxlength="200" placeholder="请选择事故发生地点" style="float:left;width:90%">
											...
											<div class="col-md-5">
		                                        ...
		                                        <div class="radio-group-container">
		                                            ...
		                                            <label class="mt-radio mt-radio-outline">
		                                                <input type="radio" name="weather" value="\${item.CODE}" {@if item.CODE==data.o.weather}checked{@/if}>\${item.NAME}
		                                                <span></span>
		                                            </label>
		                                            {@/if}
		                                            {@/each}
											...
											<div class="col-md-6">
												...
												<div class="radio-group-container">
													...
													<label class="mt-radio mt-radio-outline"  style="width: 150px;">
														<input type="radio" name="vehicleType" value="\${item.CODE}" {@if item.CODE==data.o.vehicleType}checked{@/if}>\${item.NAME}
														<span></span>
													</label>
													{@/if}
													{@/each}
										...
										<div class="form-group">
											...
											<div class="col-md-5">
												<input type="text" class="form-control" name="accidentTime" value="\${data.o.accidentTime}">
												<span class="help-block"></span>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-5">
												<input type="text" class="form-control" style="width:450px" name="roadSectionId" value="\${data.o.roadSectionId}" maxlength="50" placeholder="请输入所属路段（建议字数在14个字以内，不超过50个字)">
												<span class="help-block"></span>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-5">
												<input type="text" id="roadManId" class="form-control" style="width:450px" name="roadManId" value="\${data.o.roadManId}" maxlength="50" placeholder="请输入所属路长（建议字数在14个字以内，不超过50个字)">
												<span class="help-block"></span>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-5">
												<input type="text" class="form-control" name="deadthToll" value="\${data.o.deadthToll}" maxlength="10" placeholder="">
												<span class="help-block"></span>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-5">
												<input type="text" class="form-control" name="injuries" value="\${data.o.injuries}" maxlength="10" placeholder="">
												<span class="help-block"></span>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-5">
												<div class="radio-group-container">
													...
													{@if item.CODE!=''}
													<label class="mt-radio mt-radio-outline">
														<input type="radio" name="cause" value="\${item.CODE}" {@if item.CODE==data.o.cause}checked{@/if}>\${item.NAME}
														<span></span>
													</label>
													{@/if}
													{@/each}

        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="form-control" name="deadthToll" maxlength="10" value="0"
                               onkeyup="this.value=this.value.replace(/\D/g,'')">
                        <span class="help-block"></span>
                        <div class="error-deadthToll"></div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="form-control" name="injuries" maxlength="10" value="0"
                               onkeyup="this.value=this.value.replace(/\D/g,'')">
                        <span class="help-block"></span>
                        <div class="error-injuries"></div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">

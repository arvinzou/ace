...
function getPageList() {
    var url = contextPath + "/rordDangerReport/findRordDangerReportList";
...
/*查看详情*/
function detail(id) {
    var url = contextPath + "/rordDangerReport/selectRordDangerReportByPrimaryKey";
...
function audit(params) {
    startLoad();
    $.ajax({
        url: contextPath + "/rordDangerReport/audit",
        type: "post",
        async: false,
        data: params,
...
function online(id) {
    if (confirm("确定要上架吗？")) {
        startLoad();
        $.ajax({
            url: contextPath + "/rordDangerReport/updateStatus",
            type: "post",
            async: false,
            data: {
                id: id,

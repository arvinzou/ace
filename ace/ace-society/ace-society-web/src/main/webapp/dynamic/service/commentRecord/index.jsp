...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
        ...
        <div class="form-group">
            <label class="col-md-2 view-label">业务类型</label>
            <div class="col-md-10">
                \${bisType}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">业务ID</label>
            <div class="col-md-10">
                \${bisId}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">评论人ID</label>
            <div class="col-md-10">
                \${userId}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">评论内容</label>
            <div class="col-md-10">
                \${content}
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-md-2 view-label">状态
                0-删除 1-有效 </label>
            <div class="col-md-10">
                \${status}
            </div>

                                                        ...
                                                        <div class="form-panel">
                                                            ...
                                                            <form class="form-horizontal" id="fm-add" role="form">
                                                                <div class="form-body">
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                <input type="text" class="form-control" name="subjectId" maxlength="50" placeholder="请输入议题编号（建议字数在14个字以内，不超过50个字)">
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                <input type="text" class="form-control" name="userId" maxlength="50" placeholder="请输入提交人ID（建议字数在14个字以内，不超过50个字)">
                                                                                <span class="help-block"></span>
                                                                            </div>
                                                                        </div>
                                                                                                                                             <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                <input type="text" class="form-control" name="solution" maxlength="2147483647" placeholder="请输入解决方案（建议字数在14个字以内，不超过2147483647个字)">
                                                                                <span class="help-block"></span>
                                                                            </div>
                                                                        </div>
                                                                                                                                             <div class="form-group">

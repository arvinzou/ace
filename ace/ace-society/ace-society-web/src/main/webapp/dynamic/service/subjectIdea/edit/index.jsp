<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
    ...
    <div class="form-body">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="subjectId" value="\{data.o.subjectId}" maxlength="50" placeholder="请输入议题编号（建议字数在14个字以内，不超过50个字)">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="userId" value="\{data.o.userId}" maxlength="50" placeholder="请输入提交人ID（建议字数在14个字以内，不超过50个字)">
                    <span class="help-block"></span>
                </div>
            </div>
                     <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="solution" value="\{data.o.solution}" maxlength="2147483647" placeholder="请输入解决方案（建议字数在14个字以内，不超过2147483647个字)">
                    <span class="help-block"></span>
                </div>
            </div>
                     <div class="form-group">

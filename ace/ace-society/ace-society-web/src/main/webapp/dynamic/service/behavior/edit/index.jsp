<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
    ...
    <div class="form-body">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="title" value="\{data.o.title}" maxlength="100" placeholder="请输入标题（建议字数在14个字以内，不超过100个字)">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="userId" value="\{data.o.userId}" maxlength="50" placeholder="请输入提交人（建议字数在14个字以内，不超过50个字)">
                    <span class="help-block"></span>
                </div>
            </div>
                     <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="compendium" value="\{data.o.compendium}" maxlength="300" placeholder="请输入简述（建议字数在14个字以内，不超过300个字)">
                    <span class="help-block"></span>
                </div>
            </div>
                     <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="text" class="form-control" name="submitDate" value="\{data.o.submitDate}" maxlength="" placeholder="请输入反馈日期（建议字数在14个字以内，不超过个字)">
                    <span class="help-block"></span>
                </div>
            </div>
                     <div class="form-group">

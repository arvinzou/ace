                                                            ...
                                                            <form class="form-horizontal" id="fm-add" role="form">
                                                                <div class="form-body">
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                <input type="text" class="form-control" name="title" maxlength="50" placeholder="请输入议题标题（建议字数在14个字以内，不超过50个字)">
                                                                    ...
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                <textarea name="content" id="introduce" class="introduction" placeholder="请输入议题描述"></textarea>
                                                                                <span class="help-block"></span>
                                                                            </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-10">
                                                                                <input type="text" class="form-control" name="rewardPoints" maxlength="10" placeholder="请输入奖励积分">
                                                                                <span class="help-block"></span>
                                                                            </div>
                                                                    </div>
                                                                    <div class="form-group">

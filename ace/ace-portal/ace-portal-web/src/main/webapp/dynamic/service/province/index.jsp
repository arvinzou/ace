		...
		<div class="widget-body">
			<div class="widget-main padding-6">
				<form action="#" id="fm-search">
					地区： <input id="cc1" name="parent_code"
                ...
                lines:false,"
					 ...
					 <a
						href="javascript:clearQparams()">清除</a> 名称： <input
						name="name" type="text" maxlength="20"
						style="width: 200px; height: 25px;" />
					<button class="btn btn-info" id="btn-search"
							authority="${pageContext.request.contextPath}/province/findProvinceList.do">
						<i
				...
				<div id="toolbar" class="toolbar">
					...
					<button class="btn btn-info" id="btn-view-add"
							authority="${pageContext.request.contextPath}/province/insertProvince.do">
						<i
								class="ace-icon fa fa-plus-square  align-middle bigger-125 icon-on-right"></i>
					</button>
					<button class="btn btn-info" id="btn-view-edit"
							authority="${pageContext.request.contextPath}/province/updateProvince.do">
						<i
								class="ace-icon fa fa-edit  align-middle bigger-125 icon-on-right"></i>
					</button>
					
					<button class="btn btn-warning" id="btn-view-del"
							authority="${pageContext.request.contextPath}/province/delProvinceByPrimaryKey.do">
						<i
	...
	<div class="easyui-layout" id="cc" style="width: 100%; height: 300px;">
		...
		<div id="cc-west" class="easyui-west"
			...
			<ul id="tt" class="easyui-tree"
				data-options="
               url: '${pageContext.request.contextPath}/system/selectProvinceTreeList.do',
                method: 'get',
                animate: true,
                lines:false,
...
<script
		src="${pageContext.request.contextPath}/content/service/province/config.js?version=${cfg.version}"></script>
<script
		src="${pageContext.request.contextPath}/content/service/province/model.js?version=${cfg.version}"></script>
<script
		src="${pageContext.request.contextPath}/content/service/province/controller.js?version=${cfg.version}"></script>
<script
		src="${pageContext.request.contextPath}/content/service/province/view.js?version=${cfg.version}"></script>

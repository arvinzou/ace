...
<html lang="cn">
	...
	<body>
						...
						<form action="#" id="fm-search">
							...
							<div class="input-group" style="width:35%;float:right">
								...
								<span class="input-group-btn">
									<button class="btn  btn-default search_btn" id="btn-search" authority="${pageContext.request.contextPath}/queueCmccHis/findQueueCmccHisList.do">
										搜索
									</button>
								</span>
							</div>
		...
		<script src="${pageContext.request.contextPath}/content/service/queueCmccHis/config.js?version=${cfg.version}"></script>
		<script src="${pageContext.request.contextPath}/content/service/queueCmccHis/model.js?version=${cfg.version}"></script>

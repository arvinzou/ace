...
function App() {
    ...
    loader({
        path: contextPath,
        url: '/dynamic/service/pageEdit/d797c47769414b2b97993f9b98b1b65aa/css/style.css',
        type: 'css'
    });
    loader({
        path: contextPath,
    ...
    loader({
        path: contextPath,
        url: '/dynamic/service/pageEdit/d797c47769414b2b97993f9b98b1b65aa/js/upload.js',
        type: 'js',
        callback: function () {

...
<head>
    ...
    <script src="${portalPath}/content/service/tpl/js/act.js?v=${cfg.version}"></script>
...
<script id="tpl-box" type="text/template">
    ...
    {@each data.data as item}
        <div class="list">
            ...
            <p class="listIntro">\${item.remark}</p>
            <img src="\${item.cover}" class="img-tpl">
            <a href="javascript:insertTplPageByTplId('\${item.id}')" class="btn btn_primary chooseBtn">选择</a>
        </div>
    {@/each}
    </div>
</script>

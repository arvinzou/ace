		...
		<div class="row custom-toolbar">
			...
			<div class="col-md-8">
				...
				<form action="#" id="fm-search" >
					...
					<span class="input-group-addon" style="width:40px;float:left;"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> 至 </font></font></span>
					<div class="input-group date form_datetime" style="width:25%;float:left;border: 1px solid #efefef;">
...
<script src="${portalPath}/content/portal/js/logs/config.js?version=${cfg.version}"></script>
<script src="${portalPath}/content/portal/js/logs/model.js?version=${cfg.version}"></script>
<script
		src="${portalPath}/content/portal/js/logs/controller.js?version=${cfg.version}"></script>
<script
		src="${portalPath}/content/portal/js/logs/view.js?version=${cfg.version}"></script>

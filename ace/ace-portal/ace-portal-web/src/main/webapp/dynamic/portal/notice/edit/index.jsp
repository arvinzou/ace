...
<script id="tpl-fm" type="text/template">
    <input type="hidden" name="noticeId" value="\${data.o.noticeId}">
    <div class="form-body">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="title" value="\${data.o.title}" maxlength="100" placeholder="请输入标题（建议字数在28个字以内，不超过100个字)">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10 radio-group-container">
                <label>
                    <input type="radio" name="category" value="1" \${data.o.category==1?'checked':''}><span style="padding:10px">系统</span>

                </label>
                <label>
                    <input type="radio" name="category" value="2" \${data.o.category==2?'checked':''}><span style="padding:10px">业务</span>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="deadline" value="\${data.o.deadline}">

...
var exportTypes = ['txt','json','xml','csv','sql'];
var tempStr = "";
...
$menu.find(".dropdown-menu-default li").click(function () {
    ...
    var doExport = function () {
            ...
            console.log({type:type,escape:'false',fileName: cfg.fileName+'v'+getNowFormatDate()});
            ee.tableExport({type:type,escape:'false',fileName: cfg.fileName+'v'+getNowFormatDate()});
        };
   doExport();
});
//导出按钮的构建

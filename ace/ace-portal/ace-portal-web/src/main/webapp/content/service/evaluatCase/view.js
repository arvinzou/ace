...
function style_edit_form(form) {
    form.find('input[name=sdate]').datepicker({
        ...
        .end().find('input[name=isAnswer1]').addClass('ace ace-switch ace-switch-5').after('<span class="lbl"></span>')
        .end().find('input[name=isAnswer2]').addClass('ace ace-switch ace-switch-5').after('<span class="lbl"></span>')
        .end().find('input[name=isAnswer3]').addClass('ace ace-switch ace-switch-5').after('<span class="lbl"></span>')
        .end().find('input[name=type]').addClass('ace ace-switch ace-switch-5').after('<span class="lbl"></span>')
        .end().find('input[name=isAnswer4]').addClass('ace ace-switch ace-switch-5').after('<span class="lbl"></span>');
    var buttons = form.next().find('.EditButton .fm-button');

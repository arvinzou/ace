var portalPath='http://192.168.1.104:6001/rvc'
jQuery(function($) {
	init_uploader({
		extensions : "jpg,gif,png,bmp",
		url : portalPath + '/file/upload.do',
		target : "url",
		multipart_params : {}
	});
});
...
function initPhotoDom(rst,id){
 var html=new Array();
        ...
        $.each($(rst),function(i,o){
                ...
                html.push('<li>');
                html.push('<a href="javascript:false"><img style="padding:20px" alt="60x60" id="btn-image-upload" class="photo" src="../image/add.png"></a>');
                html.push('</li>');
	            html.push('</ul>');

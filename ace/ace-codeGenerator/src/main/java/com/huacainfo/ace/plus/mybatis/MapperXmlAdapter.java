...
public class MapperXmlAdapter extends PluginAdapter {
    ...
    private XmlElement VoColumnList(IntrospectedTable introspectedTable) {
        ...
        //
        TextElement textItem = new TextElement(text.toString());
    ...
    private XmlElement Where_Condition(IntrospectedTable introspectedTable) {
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable.getNonPrimaryKeyColumns()) {
            ...
            //test
            sb.setLength(0);
            sb.append("condition.").append(introspectedColumn.getJavaProperty()).append(" != null and ");
            sb.append("condition.").append(introspectedColumn.getJavaProperty()).append(" !=&quot;&quot;");

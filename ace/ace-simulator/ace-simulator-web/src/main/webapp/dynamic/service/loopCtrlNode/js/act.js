...
function getPageList() {
    var url = contextPath + "/loopCtrlNode/findLoopCtrlNodeList";
    params['loopName'] = $("input[name=keyword]").val();
    startLoad();
...
/*查看详情*/
function detail(id) {
    var url = contextPath + "/loopCtrlNode/selectLoopCtrlNodeByPrimaryKey";
...
function audit(params) {
    startLoad();
    $.ajax({
        url: contextPath + "/loopCtrlNode/audit",
        type: "post",
        async: false,
        data: params,
...
function close(id) {
    if (confirm("确定要关闭吗？")) {
        startLoad();
        $.ajax({
            url: contextPath + "/loopCtrlNode/updateState",
            type: "post",
            async: false,
            data: {
                id: id,
...
﻿function initPreview(id) {
    startLoad();
    $.ajax({
        url: contextPath + "/loopCtrlNode/selectLoopCtrlNodeByPrimaryKey",
        type: "post",
        async: false,
        data: {
            id: id
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result.status == 0) {
                ...
                render('#stationCode', dataList, 'stationCode-tpl');
            } else {
                alert(result.errorMessage);
            }
        },

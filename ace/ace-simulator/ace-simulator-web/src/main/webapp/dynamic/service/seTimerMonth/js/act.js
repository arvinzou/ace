...
function getPageList() {
    var url = contextPath + "/seTimerMonth/findSeTimerMonthList";
...
/*查看详情*/
function detail(id) {
    var url = contextPath + "/seTimerMonth/selectSeTimerMonthByPrimaryKey";
...
function audit(params) {
    startLoad();
    $.ajax({
        url: contextPath + "/seTimerMonth/audit",
        type: "post",
        async: false,
        data: params,
...
function online(id) {
    if (confirm("确定要上架吗？")) {
        startLoad();
        $.ajax({
            url: contextPath + "/seTimerMonth/updateStatus",
            type: "post",
            async: false,
            data: {
                id: id,
...
﻿function initPreview(id) {
    startLoad();
    $.ajax({
        url: contextPath + "/seTimerMonth/selectSeTimerMonthByPrimaryKey",
        type: "post",
        async: false,
        data: {
            id: id

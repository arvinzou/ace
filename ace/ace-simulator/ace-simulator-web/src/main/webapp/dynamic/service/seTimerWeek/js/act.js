...
function getPageList() {
    var url = contextPath + "/seTimerWeek/findSeTimerWeekList";
...
/*查看详情*/
function detail(id) {
    var url = contextPath + "/seTimerWeek/selectSeTimerWeekByPrimaryKey";
...
function audit(params) {
    startLoad();
    $.ajax({
        url: contextPath + "/seTimerWeek/audit",
        type: "post",
        async: false,
        data: params,
...
function online(id) {
    if (confirm("确定要上架吗？")) {
        startLoad();
        $.ajax({
            url: contextPath + "/seTimerWeek/updateStatus",
            type: "post",
            async: false,
            data: {
                id: id,
...
﻿function initPreview(id) {
    startLoad();
    $.ajax({
        url: contextPath + "/seTimerWeek/selectSeTimerWeekByPrimaryKey",
        type: "post",
        async: false,
        data: {
            id: id

...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="itemDecipt"
                               value="\{data.o.itemDecipt}" maxlength="100"
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="itemKey"
                               value="\{data.o.itemKey}" maxlength="50"
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="itemValue"
                               value="\{data.o.itemValue}" maxlength="200"

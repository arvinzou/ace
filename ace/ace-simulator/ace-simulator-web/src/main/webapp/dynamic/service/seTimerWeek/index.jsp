...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
        ...
        <div class="form-group">
            <label class="col-md-2 view-label">星期1</label>
            <div class="col-md-10">
                \${w1}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">星期2</label>
            <div class="col-md-10">
                \${w2}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">星期3</label>
            <div class="col-md-10">
                \${w3}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">星期4</label>
            <div class="col-md-10">
                \${w4}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">星期5</label>
            <div class="col-md-10">
                \${w5}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">星期6</label>
            <div class="col-md-10">
                \${w6}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">星期7</label>
            <div class="col-md-10">
                \${w7}
            </div>
        </div>

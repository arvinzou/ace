...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <ul class="objectType">
                    {@each data.s as ite,inde}
                        {@if ite.NAME}
                        <li>
                            <input name="category" \${data.o.category==ite.CODE?'checked':''} value="\${ite.CODE}" type="radio" id="ss\${inde}">
                            <label for="ss\${inde}">\${ite.NAME}</label>
                        </li>
                        {@/if}
                    {@/each}
                </ul>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <ul class="objectType">
                    <li>
                        <input name="linkType" value="1" type="radio" \${data.o.linkType=='1'?'checked':''}  id="s1" onchange="changeUrl(1)">
                    ...
                    <li>
                        <input name="linkType" value="2" \${data.o.linkType=='2'?'checked':''}  type="radio" id="s2" onchange="changeUrl(2)">

...
<div class="portlet light">
    ...
    <div class="portlet-body" id="courseSource">
        <div class="form-panel">
            <!--具体界面元素开始-->
            <form class="form-horizontal" id="fm-edit" role="form" style="max-width: 90%">
...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="smsName"
                       value="\${data.o.smsName}" maxlength="50"
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                 <textarea name="smsContent" class="form-control" maxlength="200" rows="7"
                           placeholder="请输入模板内容（建议字数在100个字以内,不超过200个字)">\${data.o.smsContent}</textarea>
                <span class="help-block"></span>
            </div>
        </div>
        <div class="form-group">

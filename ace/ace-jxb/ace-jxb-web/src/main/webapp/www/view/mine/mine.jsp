		...
		<div class="box">
			<div class="row"  style="padding-top: 0.533333rem;">
				<div class="col-xs-2 col-sm-2">
					<span class="img_box"><img src="img/headImg.png"/></span>
				</div>
				<div class="col-xs-7 col-sm-7">
					<div class="row">
						<div class="col-xs-5 col-sm-5" style="padding: 0;"><p class="title01">肖海平</p></div>
						<div class="col-xs-7 col-sm-7">
					...
					<div class="row"><p class="content">国家二级心理咨询师</p></div>
				</div>

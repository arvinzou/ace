...
(function () {
    ...
    var Swiper = function (container, params) {
        ...
        s.a11y = {
            ...
            jxbRegion: $('<span class="swiper-notification" aria-jxb="assertive" aria-atomic="true"></span>'),
        
            notify: function (message) {
                var notification = s.a11y.jxbRegion;
            ...
            init: function () {
                ...
                $(s.container).append(s.a11y.jxbRegion);
            },
            ...
            destroy: function () {
                if (s.a11y.jxbRegion && s.a11y.jxbRegion.length > 0) s.a11y.jxbRegion.remove();
            }
        };

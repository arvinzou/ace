...
function createH5Video(e, i, a, n) {
    if ($("#j-video-wrap").data("poster", e).data("src", i), "ios" == videoOsType) {
        if ($("#j-video-controls .c_timeline").addClass("fn-hide"), $("#j-video-controls").removeClass("fn-hide"), $("#j-video-controls .c_timeline").length) $("#j-video-controls .c_play").on(tap,
            function () {
                $(this).hasClass("c_pause") ? ($("#j-video-wrap video")[0].pause(), $(this).removeClass("c_pause"), $("#j-jxbvideo-tip").removeClass("fn-hide").find("img").hide()) : ($("#j-video-wrap video")[0].play(), $(this).addClass("c_pause"), $("#j-jxbvideo-tip").addClass("fn-hide"))
            });
        else {
            var o = !0;
            $("#j-video-controls .c_play").on(tap,
                function () {
                    $(this).hasClass("c_pause") ? ($("#j-jxbvideo-main").addClass("fn-hide"), $("#j-video-wrap").html(""), $("#j-jxbvideo-tip").removeClass("fn-hide")) : (playH5Video(o), o = !1)
                })
        }
...
function playH5Video(e) {
    ...
    $("#j-jxbvideo-main").removeClass("fn-hide"),
        $("#j-jxbvideo-tip").addClass("fn-hide");
    ...
    r.off("waiting").on("waiting",
        ...
        r.off(tap).on(tap,
            function () {
                a.hasClass("fn-hide") ? a.removeClass("fn-hide") : ($("#j-jxbvideo-tip").removeClass("fn-hide").find("img").hide(), this.pause())
            });
    ...
    r.off("play").on("play",
        function () {
            n = !0,
            s || (s = !0, i(), clickSetSpeed($("#j-jxbvideo-main")))
        }),
        ...
        r.off("pause").on("pause",
            function () {
                $("#j-jxbvideo-tip").removeClass("fn-hide").find("img").hide(),
                    n = !1,
                s || (s = !1)
            }),
        r.off("ended").on("ended",
            function (e) {
                $("#j-jxbvideo-tip").removeClass("fn-hide").find("img").show()
            }),
        $("#j-jxbvideo-main video").off("error").on("error",
            function (e) {
                $("#j-jxbvideo-main, #j-jxbvideo-tip .playbtn").addClass("fn-hide"),
                    $("#j-jxbvideo-tip, #j-jxbvideo-tip .tip, #j-jxbvideo-tip .v-mask").removeClass("fn-hide"),
                    $("#j-v-loading-new").addClass("fn-hide"),
                    $("#j-v-loading").addClass("fn-hide")
            })
}
...
function getInfo() {
    ...
    lvsCmd.ajax(apiServer + "/www/jxb/getInfo.do", e,
        function (e, i) {
            function a() {
                $(window).scrollTop() <= 10 && (d = !1),
                d || ($(window).scrollTop() < c - l ? ($("#j-jxbvideo").removeClass("minvideobar"), $("#j-video-wrap").height(c)) : ($("#j-jxbvideo").addClass("minvideobar"), $("#j-video-wrap").height(l)))
            }
                        ...
                        function () {
                            ...
                            a.addClass("xc-liker-ing"),
                                setTimeout(function () {
                                    ...
                                    600),
                            i && lvsCmd.ajax(apiServer + "/www/jxb/addLike.do", e,
                                function (e, n) {
                                    if ("0" == n.status) {
            ...
            if (e) {
                ...
                if (void 0 == window.orientation && (i.ispc = !0), $("#j-jxbinfo").html(jxbinfoTpl.render(i)), $("#j-jxbvideo").length) {
                    var o = "/jxb/content/www/img/ic_default_pic@2x.png";
                    o = i.data.cover;
                    var t = i.data.playStreamUrl;
                    if (void 0 == window.orientation) {
                        $("#j-jxbvideo-main").addClass("prism-player").removeClass("fn-hide"),
                            $("#j-jxbvideo-tip").addClass("fn-hide");
                        var r = {
                            id: "j-video-wrap",
                            source: t,
                            ...
                            autoplay: !1,
                            width: "100%",
                            height: $("#j-jxbinfo .view").height() + "px"
                        };
                        ...
                        if ($("#j-jxbvideo-tip").on(tap,
                            ...
                            $(window).scroll(a),
                                ...
                                $("#j-v-close").on(tap,
                                    function () {
                                        $("#j-jxbvideo").removeClass("minvideobar"),
                                            $("#j-video-wrap").height(c),
                                            $("#j-video-wrap video")[0] ? ($("#j-video-wrap video")[0].pause(), $("#j-jxbvideo-tip").removeClass("fn-hide").find("img").hide()) : $("#j-jxbvideo-tip").removeClass("fn-hide"),
                                            d = !0
                                    })
                        }
                    }
               ...
               $.leftTime(i.data.startTime,function(d){
                ...
                i && i.data && (i.data.topic && (wxShareDict.title = i.data.topic, document.title = wxShareDict.title), i.data.remark && (wxShareDict.desc = i.data.remark), i.data.cover && (wxShareDict.imgUrl = i.data.cover), onshare()),
                    increateNumTimeFn(),
                    lvsCmd.ajax(apiServer + "/www/jxb/getTotalNumAndOrgInfo.do", {
                            companyId: companyId,
                            id: lvsCmd.urlParams.id
                        },
                        function (e, i) {
...
function getReport(e, i) {
    ...
    i || $("#j-listmore").removeClass("fn-hide"),
        lvsCmd.ajax(apiServer + "/www/jxb/getLiveRptList.do", {
...
function dianZan(e) {
    ...
    lvsCmd.ajax(apiServer + "/www/jxb/addLike.do", i,
        function (i, a) {
            if ("0" == a.status) {
                var n = $("#j-remark-" + e);
                var s = $("#liker" + e).html();
...
function increateNumTimeFn() {
    if ($(window).scrollTop() > cutWindowScrollTop && (cutWindowScrollTop = $(window).scrollTop()), $("#j-report li").each(function () {
        ...
        if ($.each(viewReportList,
            ...
            /*
             lvsCmd.ajax(apiServer + "/h5/jxb/increaseNum.json", i,
             function(e, i) {
             isPostView = !1,
             increateNumTimeFn()
             })*/
...
var jxbinfoTpl = juicer($("#j-jxbinfo script").html());
if ($("#j-jxbinfo script").remove(), userAgent.indexOf("iphone") > -1 || userAgent.indexOf("ipad") > -1 || userAgent.indexOf("mac") > -1) var videoOsType = "ios";
...
if (getReport(reportPage), setInterval(function () {
            return !(reportLoading || $(window).scrollTop() > $("#j-jxbinfo").height() || $(".fn-contain").hasClass("j-hasremark") || 1 == reportSort) && void getReport(1, !0)
        },
        1e4), $("#j-sort").on(tap,
        function () {
            load = false;
        ...
        if (a) {
            ...
            lvsCmd.ajax(apiServer + "/www/jxb/cmt.do", n,
                function (e, n) {
                    if (e) if (0 == n.status) {
    ...
    //     appid: ""
    // };
    lvsCmd.ajax(apiServer + "/www/jxb/getWxJsSign.do", {companyId: companyId},
        function (e, i) {
            wx.config({
                debug: false,
                appId: i.data.appId,
...
var cutWindowScrollTop = 0,
    ...
    isPostView = !1;
function getMsg() {
    lvsCmd.ajax(apiServer + "/www/jxb/getLiveMsgList.do", {rid: lvsCmd.urlParams.id},
        function (e, rst) {
...
function visit() {
    ...
    lvsCmd.ajax(apiServer + "/www/jxb/visit.do", i,
        function (i, a) {
            if ("0" == a.status) {
...
$(window).on("scroll",
    function () {
        ...
        if ($(window).scrollTop() >= 50) {
            $("#j-jxbinfo .view").css("height", "2.62rem");
            $("#j-jxbinfo .view").css("position", "fixed");
            $("#j-jxbinfo .view").css("z-index", 310);
            $("#j-jxbinfo .content").css("padding-top", "2.62rem");
            $("#j-jxbvideo-main").css("height", "2.62rem");
            //$("#j-jxbvideo-main").css("width","5rem");
            ...
            $("#j-jxbinfo .view img").css("width", "5rem");
            $("#j-jxbinfo .view img").css("float", "left");
            $(".count_down").addClass("fn-hide");
            $("#j-jxbvideo").css("height", "2.8rem");



        } else {
            $("#j-jxbinfo .view").css("height", "5.62rem");
            $("#j-jxbinfo .view").css("position", "relative");
            $("#j-jxbinfo .view").css("z-index", 0);
            $("#j-jxbinfo .content").css("padding-top", ".26rem");
            $("#j-jxbvideo-main").css("height", "5.62rem");
            //$("#j-jxbvideo-main").css("width","10rem");
            ...
            $("#j-jxbinfo .view img").css("width", "10rem");
            $("#j-jxbinfo .view img").css("float", "null");
            $(".count_down").removeClass("fn-hide");
            $("#j-jxbvideo").css("height", "5.62rem");

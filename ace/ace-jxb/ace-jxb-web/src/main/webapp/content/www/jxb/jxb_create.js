...
function uploadCover() {
    ...
    var uploader = new plupload.Uploader({
        ...
        browse_button: 'upbtn',
        url: "/jxb/www/jxb/upload.do?companyId=" + lvsCmd.urlParams.companyId,
        file_data_name: 'file',
...
//romance 自动渲染
var newTplform = new cake.tplform("j-jxbform", formFieldDict);
//标题
newTplform.render($("#j-jxbform .row-content"),
    //动态字数长度显示
    function (e) {
        function t() {
            //标题
            ...
            //直播流地址
            var jxbAddrLength = $("#j-jxb-addr .j-content").val().length;
            $("#j-jxb-addr .j-remark-length").html(jxbAddrLength + "/200"),
                jxbAddrLength > 200 ? $("#j-jxb-addr .j-remark-length").addClass("fn-color-red") :
                    $("#j-jxb-addr .j-remark-length").removeClass("fn-color-red");
            //回放地址
    ...
    function (e) {
        ...
        var url = apiServer + "/www/jxb/insertLive.do";

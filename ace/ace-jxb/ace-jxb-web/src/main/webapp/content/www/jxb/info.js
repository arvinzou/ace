...
function playH5Video(e) {
    ...
    e && ("ios" == videoOsType ? ($("#j-jxbvideo").hasClass("minvideobar") ? $("#j-v-loading").removeClass("fn-hide") : $("#j-v-loading-new").removeClass("fn-hide"), $("#j-video-wrap").html('<video poster="' + o + '" src="' + t + '" playsinline="playsinline" webkit-playsinline="webkit-playsinline"></video>')) : $("#j-video-wrap").html('<video poster="' + o + '" src="' + t + '" controls="controls"></video>'));
    ...
    function() {
        $("#j-jxbvideo-tip").removeClass("fn-hide"),
        n = !1,
        s || (s = !1)
    }),
...
function getInfo() {
    ...
    lvsCmd.ajax(apiServer + "/h5/jxb/getInfo.json", e,
    function(e, i) {
        function a() {
        ...
        if (e) {
            if (void 0 == window.orientation && (i.ispc = !0), $("#j-jxbinfo").html(jxbinfoTpl.render(i)), $("#j-jxbvideo").length) {
                var o = "//xcycdn.zhongguowangshi.com/jxb-img/ic_default_pic@2x.png?x-oss-process=image/resize,m_fill,w_750,h_422,limit_0";
            ...
            increateNumTimeFn(),
            lvsCmd.ajax(apiServer + "/h5/jxb/getTotalNumAndOrgInfo.json", {
                companyId: companyId
            },
            function(e, i) {
                if (e) {
                    ...
                    function() {
                        document.referrer && document.referrer.indexOf("//jxb.xinhuaapp.com/") > -1 ? document.referrer.indexOf("?id=") > -1 || document.referrer.indexOf("&id=") > -1 ? location.href = "/xcy/?companyId=" + companyId + "&showlink=" + showlink: document.referrer.indexOf("?companyId=") == -1 && document.referrer.indexOf("&companyId=") == -1 ? location.href = "/xcy/?companyId=" + companyId + "&showlink=" + showlink: history.back() : location.href = "/xcy/?companyId=" + companyId + "&showlink=" + showlink
                    })
                }
                lvsCmd.ajax(apiServer + "/h5/jxb/getShareContent.json", {
                    companyId: companyId
                },
                function(e, i) {
                    if (e) {

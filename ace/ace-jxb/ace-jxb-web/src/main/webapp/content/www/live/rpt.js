...
function createUpImg() {
    ...
    uploadimg = new plupload.Uploader({
        ...
        flash_swf_url: "/jxb/content/www/lib/plupload-2.1.2/Moxie.swf",
        silverlight_xap_url: "/jxb/content/www/lib/plupload-2.1.2/Moxie.xap",
...
newTplform.render($("#j-reportform .row-content"),
    ...
    function (e) {
        ...
        var l = apiServer + "/www/jxb/insertLiveRpt.do";
...
lvsCmd.ajax(apiServer + "/www/jxb/getWxJsSign.do?", {companyId: lvsCmd.urlParams.companyId},
    function (e, i) {
        wx.config({
            debug: false,
            appId: i.data.appId,
...
function uploadVoice(localId) {
    ...
    wx.uploadVoice({
        ...
        success: function (res) {
            var l = apiServer + "/www/jxb/uploadAmr.do";

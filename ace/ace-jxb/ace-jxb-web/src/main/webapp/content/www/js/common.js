...
lvsCmd.alert = function(e) {
    if (0 == $("#j-jxbalert").length) {
        var a = $('<div id="j-jxbalert" style="position:fixed;left:0;right:0;top:50%;text-align:center;z-index:99;"><span style="display:inline-block;margin:auto;padding:0.5rem;background-color:rgba(0,0,0,0.5);color:#fff;border-radius:0.2rem;"></span></div>');
        $("body").append(a)
    } else var a = $("#j-jxbalert");
    a.find("span").html(e),
    a.css("display", "block"),

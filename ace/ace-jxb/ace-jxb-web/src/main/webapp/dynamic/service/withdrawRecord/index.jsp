    ...
    <div class="portlet-body">
        ...
        <div class="table-scrollable">
            <table class="table table-hover">
                ...
                <tr>
                    <th width="10%"> 主键</th>
                    <th width="10%"> 咨询师编号</th>
                    <th width="10%"> 咨询师openId</th>
                    <th width="10%"> 提现方式 1-微信提现 2-线下打款</th>
                    <th width="10%"> 申请金额</th>
                    <th width="10%"> 税费/其它扣减金额</th>
                    <th width="10%"> 实际提现金额</th>
                    <th width="10%"> 审核状态 1-审核中 2-审核通过 3-审核失败</th>
                    <th width="10%"> 审核备注</th>
                    <th width="10%"> 备注</th>
                    <th width="10%"> 状态</th>
                    <th width="10%"> 入库日期</th>
...
<script id="tpl-fm" type="text/template">
    <div class="form-body">
        ...
        <div class="form-group">
            <label class="col-md-2 view-label">咨询师编号</label>
            <div class="col-md-10">
                \${counselorId}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">咨询师openId</label>
            <div class="col-md-10">
                \${openId}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">提现方式 1-微信提现 2-线下打款</label>
            <div class="col-md-10">
                \${withdrawType}
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="col-md-2 view-label">税费/其它扣减金额</label>
            <div class="col-md-10">
                \${taxAmount}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">实际提现金额</label>
            <div class="col-md-10">
                \${actAmount}
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 view-label">审核状态 1-审核中 2-审核通过 3-审核失败</label>
            <div class="col-md-10">
                \${auditRst}
            </div>
        </div>

<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
    ...
    <div class="form-body">
                ...
                <div class="radio-group-container">
                    ...
                    <div class="price-panel" >
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="cost" type="text" value="\${data.o.cost}" style="width:70%" class="form-control" placeholder="请输入课程售价（单位：元）" onchange="if(!/^([1-9][\d]{0,7}|0)(\.[\d]{1,2})?$/.test(this.value)){alert('金额格式不正确！');this.value='';}"/>
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-md-3 control-label">划线价格</label>
                            <div class="col-md-9">
                                <input name="primeCost" type="text" value="\${data.o.primeCost}" style="width:70%" class="form-control" placeholder="请输入划线价格（单位：元）" onchange="if(!/^([1-9][\d]{0,7}|0)(\.[\d]{1,2})?$/.test(this.value)){alert('金额格式不正确！');this.value='';}"/>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="number" class="form-control" value="\${data.o.demandNum}"  name="demandNum" placeholder="为使课程更具吸引力，请输入推荐人数">
            </div>
            <div class="col-md-4">

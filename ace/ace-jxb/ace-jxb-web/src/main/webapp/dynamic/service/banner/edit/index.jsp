    ...
    <div class="form-body">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="title" maxlength="50"
                       placeholder="请输入标题（建议字数在14个字以内，不超过50个字)" value="\${data.o.title}">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="url" maxlength="200"
                       placeholder="请输入资源地址（建议字数在14个字以内，不超过200个字)"  value="\${data.o.url}">
                <span class="help-block"></span>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10 radio-group-container">
                <label>
                    <input type="radio" name="status" value="0" \${data.o.status==0?'checked':''}><span style="padding:10px">否</span>

                </label>
                <label>
                    <input type="radio" name="status" value="1" \${data.o.status==1?'checked':''}><span style="padding:10px">是</span>

                                                                                    ...
                                                                                    <div class="md-checkbox-inline"
                                                                                        ...
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_00"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>幼儿</label>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_01"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>小学</label>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_02"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>初中</label>
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_03"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>高中</label>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="md-checkbox-inline"
                                                                                        ...
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_10"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>不合群</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_11"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>敏感自卑</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_12"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>怕生</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_13"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>注意力不集中</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_14"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>阅读障碍</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_15"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>顽皮淘气</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                        ...
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_18"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>小动作</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_19"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>网瘾</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_20"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>不爱学习</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_21"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>攀比心强</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_22"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>自控力差</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_23"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>早恋</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_24"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>沟通问题</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_25"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>依赖性强</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_26"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>考试焦虑</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_27"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>胆小懦弱</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_28"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>青春期</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_29"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>内向</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_30"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>不听话</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_31"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>做事拖拉</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_32"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>坏习惯</label>
                                                                                        </div>
                                                                                        <div class="md-checkbox hc-checkbox">
                                                                                            <input
                                                                                                    type="checkbox"
                                                                                                    ...
                                                                                                    class="md-check">
                                                                                            <label
                                                                                                    for="checkbox_33"><span
                                                                                                    class="inc"></span>
                                                                                                <span
                                                                                                        class="check"></span>
                                                                                                <span
                                                                                                        class="box"></span>考前紧张</label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>

                                                                            ...
                                                                            <div class="radio-group-container">
                                                                                ...
                                                                                <div class="price-panel">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-9">
                                                                                            <input name="primeCost" type="text" style="width:70%" class="form-control" placeholder="请输入课程原价（单位：元）" onchange="if(!/^([1-9][\d]{0,7}|0)(\.[\d]{1,2})?$/.test(this.value)){alert('金额格式不正确！');this.value='';}"/>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="row">
                                                                                        <label class="col-md-3 control-label">划线价格</label>
                                                                                        <div class="col-md-9">
                                                                                            <input name="cost" type="text" style="width:70%" class="form-control" placeholder="请输入划线价格（单位：元）" onchange="if(!/^([1-9][\d]{0,7}|0)(\.[\d]{1,2})?$/.test(this.value)){alert('金额格式不正确！');this.value='';}"/>

                                                            ...
                                                            <form class="form-horizontal" id="fm-add" role="form">
                                                                <div class="form-body">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-8">
																			<input id="mediUrl" type="text" class="form-control" name="mediUrl" maxlength="200" placeholder="音频资源的地址如:http://mp3.aile.com/mp3/a.mp3">
																			<span class="help-block"></span>
																		</div>
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		...
																		<div class="col-md-10">
																			<input type="text" class="form-control" name="duration" maxlength="28" placeholder="请输入课件时长（如：10)，单位分钟">
																			<span class="help-block"></span>
																		</div>
																	</div>

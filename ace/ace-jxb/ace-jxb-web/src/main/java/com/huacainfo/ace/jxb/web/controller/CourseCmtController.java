 ...
 */
public class CourseCmtController extends LiveBaseController {
	...
	@ResponseBody
	public PageResult<CourseCmtVo> findCourseCmtList(CourseCmtQVo condition,
			PageParamNoChangeSord page) throws Exception {
		PageResult<CourseCmtVo> rst = this.courseCmtService
				.findCourseCmtList(condition, page.getStart(), page.getLimit(),
						page.getOrderBy());
		if (rst.getTotal() == 0) {
	...
	public MessageResponse insertCourseCmt(String jsons) throws Exception {
		...
		return this.courseCmtService
				.insertCourseCmt(obj, this.getCurUserProp());
	}
    /**
	 *
	...
	public MessageResponse updateCourseCmt(String jsons) throws Exception {
		CourseCmt obj = JSON.parseObject(jsons, CourseCmt.class);
		return this.courseCmtService
				.updateCourseCmt(obj, this.getCurUserProp());
	}
    /**
	 *
	...
	@ResponseBody
	public SingleResult<CourseCmtVo> selectCourseCmtByPrimaryKey(String id)
			throws Exception {
	...
	@ResponseBody
	public MessageResponse deleteCourseCmtByCourseCmtId(String jsons)
			throws Exception {
		JSONObject json = JSON.parseObject(jsons);
		String id = json.getString("id");
		return this.courseCmtService.deleteCourseCmtByCourseCmtId(id,
				this.getCurUserProp());
	}
}

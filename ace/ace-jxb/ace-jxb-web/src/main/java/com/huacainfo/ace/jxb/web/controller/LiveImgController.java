...
public class LiveImgController extends LiveBaseController {
    ...
    @Autowired
    private LiveImgService jxbImgService;
    ...
    public MessageResponse insertLiveImg(String jsons) throws Exception {
        ...
        return this.jxbImgService.insertLiveImg(obj, this.getCurUserProp());
    }
    ...
    public MessageResponse deleteLiveImgByLiveImgId(String id)
            throws Exception {
        return this.jxbImgService.deleteLiveImgByLiveImgId(id,
                this.getCurUserProp());
    }
    ...
    public MessageResponse selectLiveImgByPrimaryKey(String id)
            throws Exception {
        return this.jxbImgService.selectLiveImgByPrimaryKey(id);
    }
    ...
    public PageResult<LiveImgVo> findLiveImgList(LiveImgQVo condition, PageParamNoChangeSord page) throws Exception {
        PageResult<LiveImgVo> rst = this.jxbImgService.findLiveImgList(condition, page.getOrderBy());
        if (rst.getTotal() == 0) {

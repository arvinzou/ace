                    ...
                    <div class="col-sm-12 clearfix margin0 ">
                        ...
                        <div class="col-sm-2 margin0 padding0">
                            <div id='external-events' class="external-events">
                                <div class="search">
                                    <input class="courseNameTeacher" type="text" style="border:1px solid lightgrey;">
                                    <button class="searchCourse"><span class="searchIcon"></span></button>
                                </div>
...
<script id="tpl-courseList" type="text/template">
    ...
    <li>
        <h5 class="teacherNameList"><i class="fa fa-user" aria-hidden="true"></i>\${index}<i
                class="fa fa-angle-double-down fr"></i></h5>
        <ul>
            {@each item as ite, ind}
            <li class='fc-event event-item bg-crew-yingji' data-teacherId="\${ite.teacherId}" data-courseId="\${ite.id}"
                data-teacher="\${index}" data-class="fc-event bg-crew-yingji">
                \${ite.name}
            </li>
            {@/each}
        </ul>

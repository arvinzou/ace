    ...
    <div class="form-body">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="category"
                               value="\{data.o.category}" maxlength="50"
                               placeholder="请输入类别（建议字数在14个字以内，不超过50个字)">
                        <span class="help-block"></span>
                    </div>
                </div>
                            <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="evaluatingId"
                               value="\{data.o.evaluatingId}" maxlength="50"
                               placeholder="请输入评测方案（建议字数在14个字以内，不超过50个字)">
                        <span class="help-block"></span>
                    </div>
                </div>
                            <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="teacherId"
                               ...
                               placeholder="请输入老师id（建议字数在14个字以内，不超过50个字)">
                        <span class="help-block"></span>
                    </div>
                </div>
                        </div>

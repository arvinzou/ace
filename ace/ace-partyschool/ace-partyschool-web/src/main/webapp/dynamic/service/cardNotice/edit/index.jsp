...
<script type="text/javascript"
        src="${portalPath}/content/common/assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js?v=${cfg.version}"></script>
<script type="text/javascript"
...
<script id="tpl-fm-edit" type="text/template">
    <input type="hidden" name="id" value="\${data.o.id}">
    <input type="hidden" name="classesId" value="\${data.o.classesId}">
    <input type="hidden" name="category" value="\${data.o.category}">
    <div class="form-body">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control" name="title" value="\${data.o.title}" maxlength="100"
                       placeholder="请输入标题（建议字数在28个字以内，不超过100个字)">

...
function getPageList() {
    var url = contextPath + "/student/findStudentList";
...
/*查看详情*/
function detail(id) {
    var url = contextPath + "/student/selectStudentByPrimaryKey";
...
function online(id) {
    if (confirm("确定要上架吗？")) {
        startLoad();
        $.ajax({
            url: contextPath + "/student/updateStatus",
            type: "post",
            async: false,
            data: {
                id: id,

				...
				<div class="row custom-toolbar">
					<form action="#" id="fm-search">
						...
						<div class="col-md-8">
							...
							<div class="btn-group" role="group" style="float:left;padding-right:15px"> <button type="button"
								 authority="false" class="btn btn-default active" onclick="setParams('category','1');">文档</button> <button type="button"
								 authority="false" class="btn btn-default" onclick="setParams('category','2');">图片</button> </div>

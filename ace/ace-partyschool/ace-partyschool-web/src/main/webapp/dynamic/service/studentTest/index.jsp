            ...
            <div class="col-md-3">
                ...
                <form onsubmit="return t_query()">
                    <div class="btn-group" role="group" id="testNumber" style="float:left;padding-right:5px">
                        <button type="button" class="btn btn-default notDoneBtn active" >未测评(<span id="notDoneTest"></span>)</button>
                        <button type="button" class="btn btn-default doneBtn">已测评(<span id="doneTest"></span>)</button>
                    </div>
                </form>
            </div>

(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<span class="prev" title="上一月" data-calendar-arrow-date><img src="img/icon-pre.png" class="opts"/></span>',
            '</div>',
            '<a href="javascript:;" data-calendar-display-date class="calendar-display">',
            '{yyyy}年<span class="m">{mm}月</span>',
            '</a>',
            '<div class="calendar-arrow">',
            '<span class="next" title="下一月" data-calendar-arrow-date disabled="true"><img disabled="true" src="img/icon-next.png" class="opts"/></span>',
            '</div>',
            '</div>',
            ...
            '<div class="calendar-hd">',
            '<div class="calendar-arrow">',
            '<span class="prev" title="上一年" data-calendar-arrow-date><img src="img/icon-pre.png" class="opts"/></span>',
            '</div>',
            '<a href="javascript:;" data-calendar-display-month class="calendar-display">{yyyy}</a>',
            '<div class="calendar-arrow">',
            '<span class="prev" title="下一年" data-calendar-arrow-date disabled="true"><img disabled="true" src="img/icon-next.png" class="opts"/></span>',
            '</div>',
            '</div>',
    ...
    Calendar.prototype = {
        ...
        getDaysHtml: function(y, m) {
            ...
            for (var n = 1, nl = 30 - count; n <= nl; n++) {
            ...
            var arr = this.getDisDateValue(),
                ...
                toggleClass = function() {
                    this.$dateItems.children(':eq(1)')
                        .find('[' + ITEM_DAY + ']:not( .' + OLD_DAY_CLASS + ')')

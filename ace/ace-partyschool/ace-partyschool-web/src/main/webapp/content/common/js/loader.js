...
function loadCommon() {
    ...
    urls.push({
        path: portalPath,
        url: '/content/common/assets/layouts/layout3/css/themes/default.min.css',
        type: 'css'
    });
    urls.push({
        path: portalPath,
        url: '/content/common/assets/global/plugins/simple-line-icons/simple-line-icons.min.css',
        type: 'css'
    });
    urls.push({path: portalPath, url: '/content/common/assets/layouts/layout3/css/custom.min.css', type: 'css'});
    urls.push({
        path: portalPath,
        url: '/content/common/assets/global/plugins/bootstrap/js/bootstrap.min.js',
        type: 'js'
    });
...
loader({
    path: portalPath,
    url: '/content/common/assets/global/plugins/jquery.min.js',
    type: 'js',
    callback: loadCommon
});

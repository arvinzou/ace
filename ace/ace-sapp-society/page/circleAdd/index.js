...
Page({
  ...
  formSubmit: function (e) {
    ...
    if (that.data.currentTab == 0) {
      data.circle.mediaType = '2';
    }
    if (that.data.currentTab == 1) {
      data.circle.mediaType = '1';
    }
    if (that.data.currentTab == 2) {
      data.circle.mediaType = '3';
    }
    console.log(data);
    util.request(cfg.server + "/society/circle/www/insertCircle", { jsons: JSON.stringify(data) },
      function (data) {
        that.setData({
          loading: false,
          disabled: false
